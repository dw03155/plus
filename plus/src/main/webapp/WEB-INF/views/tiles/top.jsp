...
<header class="header">
            ...
            <div class="top-state-wrap">
                <div id="electronNavi" class="electron-btn-navi d-none">
                    <ul>
                        <li class="js-history-back js-electron-navi"><a href="#"><i class="icon-btn-back"></i></a></li>
                        <li class="js-history-forward js-electron-navi"><a href="#"><i class="icon-btn-next"></i></a></li>
                        <li class="js-page-reload js-electron-navi"><a href="#"><i class="icon-btn-refresh js-reload-btn on"></i></a>
                            <div id="electronReloadLayer" class="electron-load-wrap js-basic-menu js-plus-area d-none">
                                <ul>
                                    <li data-code="reload" class="js-plus-area-item js-reload-menu"><a href="#">새로고침<em id="js-reload"></em></a></li>
                                    <li data-code="reload-force" class="js-plus-area-item js-reload-menu"><a href="#">강력 새로고침 (캐시비우기)<em id="js-reload-force"></em></a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="main-search-area cursor-pointer">
                ...
                <div id="searchPopupLayer" class="name-type-seach-popup" data-search-area-code="IN_TONG" style="top: 0; right: -50%; display: none">
