...
<head>
	...
	<meta property="og:image" content="https://flow.team/design2/homepage_2019/img/flow_meta_V2.png">
	...
	<meta name="twitter:description"
		content="프로젝트관리, 업무관리, 메신저, 화상회의, 파일공유&amp;보관, 간트차트, 일정관리까지! 재택근무, 원격근무, 리모트워크, 비대면 업무환경을 구축해 보세요. 지금 무료로 시작하세요.">
	<meta name="twitter:image" content="https://flow.team/design2/homepage_2019/img/flow_meta_V2.png">
	...
	<meta name="format-detection" content="telephone=no">
	<meta itemprop="image" content="https://flow.team/design2/homepage_2019/img/flow_meta_V2.png">
	...
	<script async="" src="https://apis.google.com/js/platform.js?google-drive" gapi_processed="true"></script>
	<script async="" src="https://www.dropbox.com/static/api/2/dropins.js" id="dropboxjs"
		data-app-key="mby426ffrxlv4qn"></script>
	<script async=""
...
<body>
	...
	<div id="paymentLayer" class="d-none">
		...
		<div class="upgrade-singup-header">
			<a href="#" class="logo">
				<img src="flow-renewal/assets/images/flow_logo_small.png">
			</a>
			<a id="closePayment" href="#" class="login-close-button"></a>
		</div>
		<div class="upgrade-version-wrap js-payment-layer" id="businessLayer">
			...
			<button id="helpPaymentBtn" class="upgrade-version-button-1">결제 도움말</button>
							...
							<div class="payment-left">
								...
								<ul id="payInfoUl" class="payment-info">
									<li>
										...
										<input id="userName" class="payment-input" type="text" placeholder="이름을 입력하세요">
										<p class="error-text d-none">이름을 확인해주세요</p>
									</li>
									<li>
										<label class="payment-info-title">이메일</label>
										<input id="userEmail" class="payment-input disabled" type="text"
											placeholder="helpflow@flow.team" disabled="">
									</li>
									<li>
										<label class="payment-info-title">전화번호</label>
										<input id="phoneNum" class="payment-input js-number-input" autocomplete="off"
											maxlength="15" type="text" placeholder="ex) 01012345678">
										<p class="error-text d-none">전화번호 형식이 맞지 않습니다.</p>
									</li>
									<li id="cardLi">
										<label class="payment-info-title">카드번호</label>
										<input id="cardNum1" class="payment-input input-type2 js-number-input"
											type="text" maxlength="4">
										<input id="cardNum2" class="payment-input input-type2 js-number-input"
											type="text" maxlength="4">
										<input id="cardNum3" class="payment-input input-type2 js-number-input"
											type="text" maxlength="4">
										<input id="cardNum4" class="payment-input input-type2 js-number-input"
											type="text" maxlength="4">
									...
									<li>
										...
										<input id="cardPassword" class="payment-input input-type2 js-number-input"
									...
									<li>
										...
										<input id="birthdayNum" class="payment-input js-number-input" type="text"
										...
										<ul class="payment-info">
											<li>
												...
												<ul id="payOptionSelect" class="payment-cycle-group"
													style="display: none">
													<li id="yearSelect">
														<div>연간 정기 결제<span class="payment-sale">20% 할인</span></div>
													</li>
													<li id="monthSelect">
														<div>월간 정기 결제</div>
													</li>
											...
											<li>
												<div class="payment-info-title">예상금액
												...
												<ul class="estimated-amount">
													<li>
														...
														<div>
															...
															<p class="tooltip-square">
																...
																<em>10명까지 월 <em id="monthPriceMain">60,000</em>원
																	적용,</em><br>
																<em>10명 초과 시, 인원 당 월 <em id="monthPriceSub">6,000</em>원
																	적용됩니다.</em>
															</p>
														</div>
													</li>
													<li>
														<div>예상 결제금액</div>
														<div>₩ <strong id="price">600,000,000</strong>/<em
																class="js-pay-gubun"></em></div>
													</li>
													<li>
														<div>절약금액</div>
														<div>₩ <strong id="savings">120,000,000</strong>/<em
																class="js-pay-gubun"></em></div>
													</li>
												</ul>
											</li>
											<li>
												<label class="payment-info-title">추천인 입력
													<span>필수 입력사항은 아닙니다.</span>
												</label>
												<input type="text" id="recommendId" class="payment-input"
													placeholder="아이디 또는 이메일 주소 입력">
											</li>
										</ul>
										<input type="checkbox" id="paymentAgree" class="payment-agree-input">
										<label class="payment-agree" for="paymentAgree">
											<span class="payment-agree-text"><a id="termsOfServiceBtn" href="#">정기과금
													이용약관</a> 내용을 확인하였고, 이에 동의합니다.</span>
										</label>
		...
		<div class="upgrade-version-wrap d-none js-payment-layer" id="freelancerLayer">
						...
						<fieldset>
							...
							<div class="payment-left payment-change">
								<ul id="freePaymentUl" class="payment-info">
									...
									<li>
										<label class="payment-info-title">전화번호</label>
										<input id="phoneNum" class="payment-input js-number-input" maxlength="15"
											type="text" autocomplete="off" placeholder="ex) 01012345678">
										<p class="error-text d-none">전화번호 형식이 맞지 않습니다.</p>
									</li>
									<li id="cardLi">
										<label class="payment-info-title">카드번호</label>
								...
								<div class="join-check js-join-check">
									<input id="paymentConfirmCheck" type="checkbox"
										class="js-confirm-input confirm-input">
		...
		<div id="paymentPopup" tabindex="-1" class="flow-all-background-1 d-none">
			<div class="flow-project-make-1">
				<div class="flow-project-make-2">
		...
		<div id="paymentPopupContent" class="d-none">
			<div class="js-calculator-item">
				<div class="payment-section">
					...
					<div class="payment-cycle" id="calPayOption" data-option="Y">연간 정기 결제<span class="payment-sale">20%
							할인</span></div>
					...
					<table class="payment-bill">
						<tbody>
							...
							<tr>
								...
								<td>
									<input id="calPrice" type="text" value="₩600,000">
									<span class="js-cal-gubun"> /년</span>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input id="calSavings" type="text" value="₩120,000">
									<span class="js-cal-gubun"> /년</span>
								</td>
							</tr>
						</tbody>
			...
			<div class="js-tearm-of-service-item">
				<div class="agreement-section">
					...
					<ul class="agreement-contents">
						...
						<li>・ 정확한 결제 정보를 입력하셔야 하며, 결제 정보를 제공할 경우 플로우(또는 플로우가 지정한 결제 대행업체)가 해당 거래에 필요한 결제 금액 전체를 청구할 수
							있도록 허가한 것으로 간주합니다. 부가세는 별도로 부과됩니다.</li>
						<li>・ 별도의 취소 의사가 없는한, 선택한 요금제에 과금이 진행됩니다. 취소 시, 결제 중단 처리가 되며 청구할 금액이 남아 있다면 다음달에 과금이 청구됩니다.</li>
						<li>・ 이미 지불이 완료된 금액에 대해서는 환불이 불가합니다. 단, 플로우의 귀책 사유로 인해 잘못된 금액이 결제되었거나 초과 과금이 발생한 경우 환불이 가능합니다.
						</li>
					</ul>
					<br>
					<strong>월간 과금</strong>
					<ul class="agreement-contents">
						<li>・ 매달 정기적으로 이전달 사용금액에 대해서 결제가 진행됩니다. 기본요금 이외에 등록된 매월 최대 사용인원을 기준으로 추가요금이 산정됩니다. 월간 과금에서 연간
							과금으로 전환을 지원하지 않습니다.</li>
					</ul>
					<br>
					<strong>연간 과금</strong>
					<ul class="agreement-contents">
						<li>・ 연간 사용금액에 대해서 선결제가 진행됩니다. 기본요금 이외에 등록된 사용인원을 기준으로 추가요금이 산정됩니다. 만일 연간 과금 결제 이후 추가인원이 늘어날 경우
							추가된 인원에 대해서도 과금이 청구됩니다. 연간 과금에서 월간 과금으로 전환을 지원하지 않습니다.</li>
						<li>・ 연간 과금으로 결제 시, 계약 기간 중 서비스 탈퇴 시 위약금이 발생합니다. 위약금은 "월간과금 대비 할인받은 금액 + 남은 기간 동안 지불할 금액의
							10%"이며, 위약금에는 Tax가 부과되지 않습니다.</li>
						<li>
							・ 월간과금 대비 할인받은 금액은 연간과금 계약시 체결한 월 청구금액 기준으로 계산되며, 남은 기간 동안 지불할 금액의 10%는 서비스 탈퇴 신청일부터 이전
							30일동안 최대 사용인원 기준으로 계산됩니다. <br>
					...
					<strong>결제 실패</strong>
					<ul class="agreement-contents">
						<li>・ 결제 시점에 결제가 실패하면 사용 중인 요금제는 결제중지 처리가 됩니다. 미납액이 발생하는 경우 30일 이상 지속되면 결제실패와 동일하게 처리합니다.</li>
					</ul>
					<br>
					<strong>기타</strong>
					<ul class="agreement-contents">
						<li>・ 플로우가 지정한 결제 대행업체는 결제 처리를 위해 제공해주신 결제 정보를 수집 및 저장할 수 있으며, 결제 정보는 결제 외 다른 용도로 사용되지 않습니다. 취소
							관련 문의는 <a class="payment-popup-link" href="mailto:help@flow.team">help@flow.team </a>또는 1:1
							문의하기를 통해 가능합니다.</li>
					</ul>

					<ul class="agreement-contents">
						<li>・ 본 약관에 명시되지 않은 내용은 플로우 <a class="payment-popup-link" href="/terms.act"
								target="serviceTerms">서비스 이용약관</a> 및 <a class="payment-popup-link"
								href="https://flow.team/privacy.act" target="flowPrivacy">개인정보 취급방침</a>을 따릅니다.</li>
			...
			<div class="js-account-item">
				<ul class="account-contents">
					<li>
						<i class="icon-mail"></i>
						<a href="mailto:help@flow.team">help@flow.team</a>
					</li>
					<li>
	...
	<div id="companyJoinLayer" class="d-none">
		<div class="upgrade-singup-header">
			...
			<a href="#" id="closeBtn" class="login-close-button"></a>
		</div>
		<div id="companyJoinMain" class="login-wrap invite-login">
			<div class="login-text">기존회사 참여</div>
			<div class="login-company">이미 회사에서 플로우를 사용하고 있다면 회사 URL을 입력하여 함께하세요.</div>
			<div class="join-contents">
				<p class="url-tit">회사 URL</p>
				<div class="url-wr">
					<span>https://</span>
					<input id="joinInput" type="text" class="join-input" autocomplete="off" placeholder="회사 URL">
				...
				<div class="flow-project-make-2">
					<div id="popupLayer" class="flow-login-popup popup-10">
						<div class="flow-project-header-1">
							회사 정보 확인 후 시작하세요!
							<a href="#" id="closePopupBtn" class="flow-close-type-1"></a>
						</div>
						<div class="flow-content">
							<ul class="content-company">
								<li id="companyLogoUrl" class="logo">
								</li>
								<li id="companyName" class="name">
								</li>
								<li id="companyUrl" class="url">
								</li>
							</ul>
		...
		<div id="companyWaitJoinLayer" class="upgrade-singup-wrap d-none">
			<div class="accont-wrap">
				<div class="flow-account" id="waitCompanyName">
				</div>
			...
			<div class="mini-mode-background-type-1">
				...
				<div class="mini-mode-login-section-1">
					<div class="mini-mode-password-wrap-1">
						<input type="password" id="miniPassInput" class="mini-mode-password-1 js-join-input"
							placeholder="비밀번호" data-valid="login-password" autocomplete="current-password"
							maxlength="20" data-required-yn="Y" data-empty-msg="비밀번호를 입력해주세요!"
							data-over-msg="비밀번호가 20자가 넘으셨습니다!" data-un-valid-msg="6자 이상의 영문,숫자를 입력하세요."
							data-login-err-msg="비밀번호를 확인해 주세요." value="">
						<div id="pwdViewBtn" class="mini-mode-eye-icon-1" style="display: none"></div>
					</div>
				...
				<div id="miniLockLogoutBtn" class="mini-mode-button-type-1 trans-background-button-type-1">로그아웃</div>
			</div>
		</div>
	...
	<div id="allMainContent" class="main-wrap">
		...
		<div class="main-top">
			<div id="topBanner" class="top-banner-area d-none">
				<div class="top-banner-1" banner="ie10">
					<div class="top-banner-type-2">
						<div class="top-banner-sub-type-2">
							<span>IE 10이하 버전은 지원하지 않습니다. 플로우 데스크탑 버전을 이용해 보세요!</span>
							<a href="#" class="top-banner-button">다운로드</a>
				...
				<div class="top-banner-1" banner="consult">
					<div class="top-banner-type-1">
						<div class="top-banner-sub-type-1">
							<span>30명 이상의 팀 또는 회사에서 이용하실 계획이신가요?</span>
							<a href="#" class="top-banner-button">별도 문의</a>
							<a href="#" class="top-banner-close-button"><i></i></a>
						</div>
					</div>
				</div>
				<div class="top-banner-1" banner="">
					<div class="top-banner-type-3">
						<div class="top-banner-sub-type-3">
							<span>플로우 데스크탑 버전을 이용해 보세요.</span>
							<a href="#" class="top-banner-button">다운로드</a>
							<a href="#" class="top-banner-close-button"><i></i></a>
						</div>
					</div>
				...
				<div class="top-banner-1 alarm-banner d-none" banner="alarm-step-1">
					<span class="icons-alarm-wrapper"><i class="icons-alarm"></i></span>플로우 브라우저 알림을 받아보세요!
					<a href="#" class="top-banner-close-button"><i></i></a>
					<a href="#" class="js-alarm-try top-banner-button">사용하기</a>
				</div>
				<div class="top-banner-1 alarm-banner type2 d-none" banner="alarm-step-2">
					<span class="icons-alarm-wrapper"><i class="icons-alarm"></i></span>알림을 사용하지 않으면 중요한 알림을 놓치실 수 있습니다.
					<div class="alarm-button-area">
						<button type="button" class="js-alarm-try alarm-banner-button">사용하기</button>
						<button type="button" class="js-alarm-later alarm-banner-button">나중에 하기</button>
						<button type="button" class="js-alarm-no alarm-banner-button">다시 물어보지 않기</button>
					</div>
					<a href="#" class="top-banner-close-button"><i></i></a>
				</div>
			</div>
			<header class="header">
				...
				<div class="top-state-wrap">
					<div id="electronNavi" class="electron-btn-navi d-none">
						<ul>
							<li class="js-history-back js-electron-navi"><a href="#"><i class="icon-btn-back"></i></a>
							</li>
							...
							<li class="js-page-reload js-electron-navi"><a href="#"><i
								...
								<div id="electronReloadLayer"
									...
									<ul>
										...
										<li data-code="reload-force" class="js-plus-area-item js-reload-menu"><a
												href="#">강력 새로고침 (캐시비우기)<em id="js-reload-force"></em></a></li>
									</ul>
								</div>
							</li>
						</ul>
				...
				<div class="main-search-area cursor-pointer">
					<form id="searchPopupTopButton" class="main-search clearfix">
						<div class="main-search-box">
							<input type="text" class="cursor-pointer" placeholder="전체 검색" disabled="">
							<!-- input value 값 존재 시 search-delete-button active  -->
							<button type="button" class="js-top-search-delete search-delete-button">
								<span class="blind">삭제</span>
							</button>
						</div>
						<button type="button" class="js-detail-search detail-search-button">옵션</button>
					</form>
					<div id="searchPopupLayer" class="name-type-seach-popup" data-search-area-code="IN_TONG"
						...
						<div class="search-popup-header">
							<div class="search-popup-input">
								...
								<input id="searchPopupInput" type="text" class="name-type-shift-txt" maxlength="20"
						...
						<div class="js-search-section-div">
							<p>
								카테고리
								<button class="js-mouseover" mouseover-noti="true" mouseover-text="마지막 설정값이 유지됩니다.">
							...
							<ul class="section-name-list">
								...
								<li data-code="file" class="js-search-section section-name-type-4">
									<a href="#">
										<div class="section-name-icon-4"></div>
										<span class="js-section-name">파일</span>
										<!--<span>(Alt + F)</span>-->
									</a>
								</li>
							</ul>
				...
				<div id="rightTopMenu" class="top-btns">
					<button type="button" id="organizationTopButton" class="btn-organization js-mouseover
				js-button-tooltip" mouseover-text="조직도" style="display: none;">
						<i class="icon-organization"></i>
					</button>
					<button type="button" id="chattingTopButton" class="btn-chatting js-mouseover
				js-button-tooltip" mouseover-text="채팅">
						<i class="icon-chatting"></i>
						<i id="chatTopCount" class="label-chat d-none" style="display: none;">0</i>
					</button>
					<button type="button" id="alarmTopButton" class="btn-alarm js-mouseover
				js-button-tooltip" mouseover-text="알림">
				...
				<ul id="accountLayer" class="modal-account d-none">
					<li class="user-area">
						...
						<div class="user-info">
							<strong class="js-user-name js-mouseover">cyr</strong>
							<span class="js-version">게스트 버전</span> <span>이용중</span>
						</div>
					</li>
					<!--
				<li class="user-status">
					...
					<li id="topProfile" class="user-profile">
						<i class="icons-person-3"></i>
						내 프로필
					</li>
					<li id="mySettingOpenBtn">
						<i class="icons-set"></i>
						환경설정
					</li>
					<li id="desktopDownloadBtn" class="download-desktop">
						<i class="icons-donwload"></i>
						<span class="tooltip-square">데스크탑 버전(설치형) 다운로드</span>
						PC 앱 다운로드
					</li>
					<li id="logoutBtn">
		...
		<div class="multiLang">
			...
			<div id="mutiLangResultLi" class="d-none">
				<li data-korean="{korean}" data-engilsh="{english}" data-langcode="{fullCode}"
					class="js-file-type-search-filter" style="margin-top: 10px;">
					<div class="condition-cell title" style="width:230px">
						<span class="lang_code">{code}</span>
						<span class="full_lang_code d-none">{fullCode}</span>
					</div>
					<div class="condition-cell font-size:12px">
						<div style="margin-bottom: 5px; font-size:13px; word-break: keep-all;">Korean: {korean}</div>
						<div style="font-size:13px; word-break: keep-all;">English: {english}</div>
						<div></div>
					</div>
				</li>
			</div>

			<div id="noLanguageResult" class="d-none">
				<li
					style="text-align: center; font-size: 13px; border: 1px solid #999; border-radius: 15px; padding:7px">
					{txt}
				</li>
			</div>
		</div>
		<div id="mainBodyWrap" class="main-body-wrap">
			...
			<div id="inviteEmployeeLayer" class="flow-all-background-1" style="display:none;">
				<div class="flow-project-make-1">
					<div class="flow-project-make-2">
						<div id="firstInvitePopup" class="js-invite-employee-layer popup-notice-employee"
							style="display: none">
							<div class="contents">
		 ...
		 *** 클릭 이벤트 시 span 텍스트 닫기로 변경
		 -->
				<a href="#" id="leftFilterBtn" class="left-btn-filter open d-none" style="display: none;">
		 ...
		 *** left-filter 클래스 active 추가
		 -->
				<div id="leftTask" class="left-task active">
					<div class="logo-area">
						<a class="js-logo logo-box">
							<h1 class="logo-1">
								<img src="/flow-renewal/assets/images/flow_logo.png?height=20" alt="flow" srcset="">
							</h1>
						</a>
					</div>
					...
					<ul id="leftMenuUl" class="menu-group js-left-menu mgt-20">
						<li data-code="main" class="left-menu-item flow-active">
							<a href="#">
								<i class="ico-home"></i>내 프로젝트
								<em id="leftProjectHomeCount" class="js-project-home-count project-total-count d-none"
									style="display: none;">0</em>
							</a>
						</li>
						<li data-code="open" class="left-menu-item d-none" style="display: none;">
							<a href="#">
								<i class="ico-search"></i>회사 공개 프로젝트
							</a>
						</li>
						<li data-code="nokeep" class="left-menu-item d-none">
							<a href="#"><i class="ico-not-kept"></i>미분류</a>
						</li>
						<li data-code="unread" class="left-menu-item d-none">
							<a href="#"><i class="ico-letter"></i>미확인
								<em id="unreadProjectHomeCount" class="js-project-home-count project-total-count d-none"
									style="display: none;">0</em>
							</a>
						</li>
						<li data-code="star" class="left-menu-item d-none">
							<a href="#"><i class="ico-favorite"></i>즐겨찾기</a>
						</li>
						<li data-code="hidden" class="left-menu-item d-none">
							<a href="#"><i class="ico-hide"></i>숨김</a>
						</li>
						<li class="js-project-more-button left-menu-item" data-code="project-more">
							<a href="#">
								<i class="ico-more"></i>더보기
							</a>
							<ul class="js-project-more-layer check-menu-popup left-more-menu d-none">
								<li>
								...
								<li>
									<button data-code="unread" type="button" class="left-menu-item">
										<i class="ico-letter"></i>미확인
										<em id="unreadProjectHomeCount"
					...
					<ul id="leftScroll" class="menu-accordion-group scroll-mask">
							...
							<div class="menu-accordion">
								<ul class="menu-accordion-list">
									<li data-code="task" class="left-menu-item">
										<a href="#"><i class="ico-task"></i>전체 업무
										</a>
									</li>
									...
									<li data-code="schd" class="left-menu-item">
										<a href="#"><i class="ico-schedule"></i>캘린더</a>
									</li>
									<li data-code="file" class="left-menu-item">
										<a href="#"><i class="ico-filebox"></i>파일함</a>
									</li>
									<li data-code="bookmark" class="left-menu-item">
										<a href="#"><i class="ico-bookmark"></i>북마크</a>
									</li>
									<li data-code="mention" class="left-menu-item">
										<a href="#"><i class="ico-mention"></i>나를 언급</a>
									</li>
									<li data-code="mypost" class="left-menu-item">
										<a href="#"><i class="ico-my-write"></i>내 게시물</a>
									</li>
								</ul>
							</div>
						</li>
						<li class="d-none" style="display: block;">
							<div id="RecentProjectButton" class="menu-accordion-button left-menu-item active"
								data-code="recent-project-more">
								최근 업데이트
								<i class="ico-arrow"></i>
							</div>
							<div class="menu-accordion">
								<ul id="RecentProjectUl" class="menu-accordion-list d-none" style="display: block;">
									<li class="recent-project-item" data-project-srno="1072161" data-color-code="2">
										<div class="squre-type color-code-2 ">
											<div class=""></div>
										</div>
										<span class="js-mouseover ellipsis" mouseover-text="1:1 문의하기">1:1 문의하기</span>
									</li>

									<li class="recent-project-item" data-project-srno="1072160" data-color-code="0">
										<div class="squre-type color-code-0 ">
											<div class=""></div>
										</div>
										<span class="js-mouseover ellipsis" mouseover-text="플로우 이용 가이드">플로우 이용
											가이드</span>
									</li>
								</ul>
						...
						<li>
							<div id="allLabelLeftButton" class="menu-accordion-button left-menu-item active"
								data-code="label-more" data-select-label-srno="" data-select-label-name="">
								프로젝트 폴더
							...
							<div class="menu-accordion">
								<ul id="allLabelUl" class="menu-accordion-list d-none ui-sortable"
									style="display: block;">
									<li id="label-1" label-srno="1" class="label-item ">
										<i class="ico-label"></i>
										<span class="js-label-name js-mouseover ellipsis"
											mouseover-text="마케팅">마케팅</span>
									...
									<li id="label-2" label-srno="2" class="label-item ">
										<i class="ico-label"></i>
										<span class="js-label-name js-mouseover ellipsis"
											mouseover-text="디자인">디자인</span>
										<a href="#" class="js-label-setting-button flow-dash-three">
											<div></div>
											<div></div>
											<div></div>
									...
									<li id="label-3" label-srno="3" class="label-item ">
										<i class="ico-label"></i>
										<span class="js-label-name js-mouseover ellipsis"
											mouseover-text="엔지니어링">엔지니어링</span>
										<a href="#" class="js-label-setting-button flow-dash-three">
											<div></div>
											<div></div>
											<div></div>
					...
					<div class="js-label-setting-layer setting-popup flow-small-layer-1 cursor-pointer"
						style="display: none">
					...
					<ul id="leftBottomUl" class="menu-group admin">
						<li data-code="invite-member" class="d-none js-invite-employee-button left-menu-item"
							style="display: none;">
							<a href="#"><i class="ico-invite"></i>직원 초대</a>
						</li>
						<li data-code="manager-admin" class="d-none left-menu-item" style="display: none;">
							<a href="#"><i class="ico-admin"></i>어드민</a>
						</li>
						<li data-code="service-upgrade" class="d-none left-menu-item" style="display: block;">
							<a href="#">
								<span class="ico-flow"><span class="path1"></span><span class="path2"></span><span
										class="path3"></span><span class="path4"></span><span class="path5"></span><span
										class="path6"></span><span class="path7"></span><span
										class="path8"></span></span>서비스 업그레이드</a>
						</li>
					</ul>
				</div>
				...
				<div id="leftFilter" class="left-filter">
					...
					<!-- 전체 업무 -->
					<ul id="allTaskFilter" class="menu-accordion-group scroll-mask js-left-filter-ul d-none"
						style="display: none;">
						<li id="taskGroupFilter" class="js-filter-type" filter-type="radio">
							<div class="js-accordion-button menu-accordion-button active left-menu-item">
								업무 구분
								<i class="ico-arrow"></i>
							</div>
							<div class="menu-accordion">
								<ul class="menu-accordion-list">
									...
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text on" filter-gb="3">
											<p>
												<i class="js-common-radio all-checked"></i>
												<span>전체</span>
											</p>
										</div>
									</li>
						...
						<li id="taskStatusFilter" class="js-filter-type" filter-type="check">
							<div class="js-accordion-button menu-accordion-button left-menu-item">
								상태
								<i class="ico-arrow"></i>
							</div>
							<div class="menu-accordion">
								<ul class="menu-accordion-list">
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" status-filter="0">
											<p>
												<i class="js-search-checkbox all-checked"></i>
												<span class="state request">요청</span>
											</p>
										</div>
									</li>
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" status-filter="1">
											<p>
												<i class="js-search-checkbox"></i>
												<span class="state progress">진행</span>
											</p>
										</div>
									</li>
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" status-filter="4">
											<p>
												<i class="js-search-checkbox"></i>
												<span class="state feedback">피드백</span>
											</p>
										</div>
									</li>
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" status-filter="2">
											<p>
												<i class="js-search-checkbox"></i>
												<span class="state completion">완료</span>
											</p>
										</div>
									</li>
									<li class="left-menu-item">
						...
						<li id="taskPriorityFilter" class="js-filter-type" filter-type="check">
							<div class="js-accordion-button menu-accordion-button left-menu-item">
								우선순위
								<i class="ico-arrow"></i>
							</div>
							<div class="menu-accordion">
								<ul class="menu-accordion-list">
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" priority-filter="3">
											<p>
												<i class="js-search-checkbox all-checked"></i>
												<span class="rank emergency">긴급</span>
											</p>
										</div>
									</li>
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" priority-filter="2">
											<p>
												<i class="js-search-checkbox"></i>
												<span class="rank high">높음</span>
											</p>
										</div>
									</li>
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" priority-filter="1">
											<p>
												<i class="js-search-checkbox"></i>
												<span class="rank normal">보통</span>
											</p>
										</div>
									</li>
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" priority-filter="0">
											<p>
												<i class="js-search-checkbox"></i>
												<span class="rank low">낮음</span>
											</p>
										</div>
									</li>
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" priority-filter="4">
											<p>
												<i class="js-search-checkbox"></i>
												<span class="rank empty">없음</span>
											</p>
										</div>
									</li>
								</ul>
						...
						<li id="taskStartDateFilter" class="js-filter-type" filter-type="radio">
							<div class="js-accordion-button menu-accordion-button left-menu-item">
								시작일
								<i class="ico-arrow"></i>
							</div>
							<div class="menu-accordion">
								<ul class="menu-accordion-list">
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text on" start-gb-filter="0">
											<p>
												<i class="js-common-radio all-checked"></i>
												<span>전체</span>
											</p>
									...
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" start-gb-filter="1">
											<p>
												<i class="js-common-radio"></i>
												<span>오늘</span>
											</p>
									...
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" start-gb-filter="2">
											<p>
												<i class="js-common-radio"></i>
												<span>이번 주</span>
											</p>
									...
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" start-gb-filter="3">
											<p>
												<i class="js-common-radio"></i>
												<span>이번 달</span>
											</p>
									...
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" start-gb-filter="4">
											<p>
												<i class="js-common-radio"></i>
												<span>미정</span>
											</p>
						...
						<li id="taskEndDateFilter" class="js-filter-type" filter-type="radio">
							...
							<div class="menu-accordion">
								<ul class="menu-accordion-list">
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text on" end-gb-filter="0">
											<p>
												<i class="js-common-radio all-checked"></i>
												<span>전체</span>
											</p>
									...
									<li class="left-menu-item js-extend-task-filter d-none">
										<div class="js-filter-button extend-task-check-text seach-check-text"
											end-gb-filter="6">
											<p>
												<i class="js-common-radio"></i>
												<span>기간설정</span>
										...
										<div class="extend-task-calendar com-calendar d-none">
											<div class="search-filter-group">
												<div class="search-filter-item js-search-pickr-layer"
													...
													<div class="js-date-type js-pickr-layer js-start-flatpickr filter-input-box active flatpickr-input"
														readonly="readonly">
														<span></span><input type="hidden" value="">
														<label class="filter-date-label"><i
																class="icon-date"></i></label>
													</div>
													<div
						...
						<li id="taskEditFilter" class="js-filter-type js-extend-task-filter d-none" filter-type="radio">
							<div class="js-accordion-button menu-accordion-button left-menu-item">
								수정일
								<i class="ico-arrow"></i>
							</div>
					...
					<!-- 전체 일정 -->
					<ul id="calendarFilter" class="js-left-filter-ul menu-accordion-group scroll-mask d-none"
						style="display: none;">
						<li>
							<div class="menu-accordion-button active left-menu-item js-left-filter-item">
								일정
					...
					<!-- 전체 파일 -->
					<ul id="fileFilter" class="js-left-filter-ul menu-accordion-group scroll-mask d-none"
						style="display: none;">
						<li>
							<div class="js-accordion-button menu-accordion-button active left-menu-item">
								파일종류
							...
							<div class="menu-accordion">
								<ul class="menu-accordion-list">
									...
									<li class="left-menu-item">
										<div class="js-filter-button seach-check-text" file-type="AUTOCAD">
											<p>
												<i class="js-common-radio"></i>
			...
			<div id="recentProjectItem" class="js-left-menu" style="display: none">
				<li class="recent-project-item" data-project-srno="{project-srno}" data-color-code="{color-code}">
					<div class="squre-type color-code-{color-code} {new}">
						<div class="{badge-display}"></div>
					</div>
					<span class="js-mouseover ellipsis" mouseover-text="{title}">{title}</span>
				</li>
			</div>

			<div id="joinProjectItem" class="js-left-menu" style="display: none">
				<dd id="project-{project-srno}" project-srno="{project-srno}" class="join-project-item">
					<a href="#">
			...
			<div id="labelItem" class="js-left-menu" style="display: none">
				<li id="label-{label-number}" label-srno="{label-number}" class="label-item {active}">
					<i class="ico-label"></i>
					<span class="js-label-name js-mouseover ellipsis" mouseover-text="{label-name}">{label-name}</span>
					<a href="#" class="js-label-setting-button flow-dash-three">
						<div></div>
						<div></div>
						<div></div>
			...
			<div id="labelSelectItem" class="d-none">
				<li class="label-item" data-label-kind="{COLABO_FLD_KIND}" data-label-srno="{COLABO_FLD_SRNO}"
					data-label-ico="{ICO_CODE}">
					<div class="label-set-item">
						<span class="label-item-text ellipsis">{COLABO_FLD_NM}</span>
						<a href="#" class="js-check-label {FLOW_CONTENT_CHECK}"></a>
					</div>
				</li>
			</div>
			...
			<div class="main-container">
					...
					<div class="all-search-container">
						<div id="searchEventArea" class="all-search-content scroll-mask">
							<div id="projectSearchArea" class="search-result-group ">
								...
								<button id="projectSearchMore" type="button" class="js-search-more search-result-more"
									data-code="project">더보기
								</button>
							</div>
							<div id="postSearchArea" class="search-result-group">
								...
								<button id="postSearchMore" type="button" class="js-search-more search-result-more"
									data-code="post">
									더보기
								</button>
							</div>
							<div id="fileSearchArea" class="search-result-group">
								...
								<button id="fileSearchMore" type="button" class="js-search-more search-result-more"
									data-code="file">
									더보기
								</button>
							</div>
				...
				<div id="postSearchResultItem" class="d-none">
					<li class="post-search-item js-search-item" data-code="post" colabo_srno="{COLABO_SRNO}"
						colabo_commt_srno="{COLABO_COMMT_SRNO}" colabo_remark_srno="{COLABO_REMARK_SRNO}"
						rgsn_dttm="{RGSN_DTTM}">
						...
						<div class="search-sub-text-wrap">
							...
							<p class="search-text-type-3 contents-project">
								<span class="search-name ellipsis">{RGSR_NM}</span> <span class="date">{date}</span><em
									class="project-title ellipsis"><i class="seach-type-2"></i>{TTL}</em>
							</p>
						</div>
				...
				<div id="fileSearchResultItem" class="d-none">
					<li class="file-search-item js-search-item" data-code="file" colabo_srno="{COLABO_SRNO}"
						colabo_commt_srno="{COLABO_COMMT_SRNO}" colabo_remark_srno="{COLABO_REMARK_SRNO}"
						use_intt_id="{USE_INTT_ID}" atch_srno="{ATCH_SRNO}" rand_key="{RAND_KEY}"
						file_type="{FILE_TYPE}" orcp_file_nm="{data_file_name}" file_size="{FILE_SIZE}"
						file_strg_path="{FILE_STRG_PATH}" img_path="{FILE_STRG_PATH}" thum_img_path="{THUM_IMG_PATH}"
						height="{HEIGHT}" width="{WIDTH}" rgsr_nm="{RGSR_NM}" rgsn_dttm="{RGSN_DTTM}">
				...
				<div id="allPostItem" class="d-none">
					<li id="allPosts-{COLABO_COMMT_SRNO}" class="js-all-post-item post-search-item post-list-wrapper"
						tmpl_type="{TMPL_TYPE}" colabo_srno="{COLABO_SRNO}" colabo_commt_srno="{COLABO_COMMT_SRNO}"
				...
				<div id="allPostSearchItem" class="d-none">
					<li class="js-all-post-item post-search-item js-search-item" tmpl_type="{TMPL_TYPE}"
						...
						<div class="search-sub-text-wrap">
							...
							<p class="search-text-type-3 contents-project">
								<span class="search-name ellipsis">{name}</span> <span class="date">{date}</span><em
									class="project-title ellipsis"><i class="icons-project-1"></i>{COLABO_TTL}</em>
							</p>
						</div>
				...
				<div id="topSettingBar" class="main-header">
					<div id="mainTop" class="title-1 d-none" data-code="main" style="display: block;">
						<div>내 프로젝트</div>
					</div>


					<span id="allCollectionCount" class="js-collection-total-count js-collection-count top-task-num"
					...
					<div id="projectHomeTop" class="main-sub-header d-none" style="display: block;">
						<div class="home-menu clearfix">
							<div class="home-menu-left">
								...
								<a href="#">
									<div id="ListTypeButton" class="menu-select-icon-type-2 type-button js-mouseover"
										mouseover-text="리스트형">
									</div>
								</a>
							</div>
							<div class="home-menu-right">
								<a href="#" id="projectOrderButton"
									...
									<div id="projectOrderList" class="js-project-order-layer menu-popup-layer-1"
										style="display: none;">
						...
						<div class="project-detail-header">
							...
							<div class="project-header-group">
								<div class="project-title-area">
									...
									<h3 id="projectTitle" class="project-title ellipsis js-mouseover" mouseover-text="">
									</h3>
									<ul class="project-status-group">
										<li id="lockIcon" class="d-none">
											<i class="sprite-detail icon-locked js-icon-locked"><span class="blind">관리자
													승인 필요</span></i>
										...
										<li id="companyIcon" class="d-none">
											<i class="sprite-detail icon-company js-icon-company"><span class="blind">회사
													프로젝트</span></i>
											<div class="tooltip-square">
												<em class="tooltip-title">회사 프로젝트</em>
												<p class="tooltip-text">회사 직원 모두가 자동 참여되는 프로젝트로 임의로 참여자를 내보내거나 외부 직원을
													초대할 수 없습니다.</p>
											</div>
										</li>
										<li id="openProjIcon" class="d-none">
											<i class="sprite-detail icon-open-project js-icon-open-project"><span
										...
										<li id="unalarmIcon" class="d-none">
											<i class="sprite-detail icon-unalarm js-icon-un-alarm"><span
													class="blind">푸시 알림 OFF</span></i>
											<div class="tooltip-square">
												<em class="tooltip-title">푸시 알림 OFF</em>
												<p class="tooltip-text">휴대폰 푸시 또는 브라우저에 알림이 가지 않습니다. 프로젝트 [알림 설정]메뉴에서
													변경할 수 있습니다.</p>
											</div>
										</li>
				...
				<div id="mainContent" class="main-content scroll-mask" scroll-direction="0">
					...
					<div id="projectHomeLayer" class="project-home-wrap" style="display: block;">
						<div class="small-style-wrap">
									...
									<div class="section-1">
										<ul id="projectBoardUl" class="project-group clearfix">
											...
											<li id="project-1072161" class="project-item ui-state-default"
												label-srnos="" project-srno="1072161">
												<a href="#">
													<div class="flow-content-ct project-badge" style="display:none"
														data="">0</div>
													...
													<div class="left-menu-type-con">
														<div
															class="project-star flow-content-star flow-content-star-un">
														</div>
														<div class="flow-content-txt project-ttl">1:1 문의하기</div>
														<div class="flow-content-b-c">
															<div class="flow-content-hm-txt"><i
																	class="icons-person-2"></i></div>
															...
															<div class="flow-content-fl-r">
																...
																<div class="project-stat-ico icon-company js-mouseover"
																	mouseover-text="회사 프로젝트" style="display:none"
																	data=""></div>
															</div>
														</div>
													</div>
											...
											<li id="project-1072160" class="project-item ui-state-default"
												label-srnos="" project-srno="1072160">
												<a href="#">
													<div class="flow-content-ct project-badge" style="display:none"
														data="">0</div>
													<button class="edit-check flow-content-chk"
							...
							<ul id="allProjectBoardItem" style="display: none">
								{label}
								<li id="project-{project-number1}" class="project-item ui-state-default"
									label-srnos="{label_srnos}" project-srno="{project-number1}">
									<a href="#">
										<div class="flow-content-ct project-badge" {badge-display}="">{badge-count}
										</div>
							...
							<ul id="allProjectListItem" style="display: none">
								{label}
								<li id="project-{project-number2}" class="project-item ui-state-default"
									project-srno="{project-number2}" label-srnos="{label_srnos}">
									<a href="#">
										<button class="edit-check flow-content-chk d-none"></button>
										<div class="color-code flow-content-list flow-content-po-t color-code-{color-code}"
											data-color="{color-code}"></div>
								...
								<div class="btns-wr">
									<div class="project-search-area all-file-header-type-3">
										<div class="project-search">
											...
											<input type="text" placeholder="업무명 또는 업무번호를 검색하세요!" autocomplete="off"
												maxlength="20" class="js-task-search-input project-search-input">
											<button type="button"
												class="js-task-detail-search-button search-set-button">옵션</button>
											<div class="js-task-detail-search-layer name-type-seach-popup d-none"
												...
												<div class="detail-search-conditions">
													...
													<div class="condition-button-area">
														...
														<div class="condition-right">
															<button
																class="js-filter-cancel condition-button cancel">취소</button>
															<button
																class="js-filter-search condition-button search">검색</button>
														</div>
													</div>
												</div>
											</div>
							...
							<div class="allFileLayer full-width small-style-wrap-2 d-none" style="display: none;">
								<div class="btns-wr">
									<div class="project-search-area all-file-header-type-3">
										<div class="project-search">
											<i class="icons-search"></i>
											<input type="text" placeholder="파일명을 검색해주세요!" autocomplete="off"
												maxlength="20" class="js-file-search-input project-search-input">
											<button type="button"
									...
									<div class="btns-area">
										...
										<a href="#" id="changeBoardTypeButton"
								...
								<div id="fileItemArea" class="all-file-area board">
									<div id="allFileSort" class="js-sort-layer all-file-list-setup-type-1">
										<div id="fileUploadSort" class="js-sort-file all-file-list-setup-1 check"
											data-sort-code="EDTR_DTTM">
											<span>최근 업로드순</span><em></em></div>
										<div id="fileNameSort" class="js-sort-file all-file-list-setup-1"
									...
									<ul id="fileItemUlHead" class="js-sort-layer file-item-head">
										<li>
											...
											<div class="js-sort-file all-file-list-name-type-2"
												data-sort-code="RGSR_NM"><span
													class="all-file-list-sort">등록자<em></em></span>
											</div>
											<div class="js-sort-file all-file-list-name-type-3 check"
												data-sort-code="EDTR_DTTM"><span
													class="all-file-list-sort">등록일시<em></em></span></div>
											<div class="js-sort-file all-file-list-sort all-file-list-name-type-5">
											</div>
										</li>
									</ul>
									<ul id="fileLayerUl"
								...
								<ul id="boardTypeFileItem" style="display:none;">
									<li class="js-file-board js-selectable ui-selectee {download_yn}"
										rand_key="{RAND_KEY}" thum_img_path="{THUM_IMG_PATH}" width="{WIDTH}"
										height="{HEIGHT}" orcp_file_nm="{DATA_ORCP_FILE_NM}" colabo_srno="{COLABO_SRNO}"
										colabo_commt_srno="{COLABO_COMMT_SRNO}" img_path="{IMG_PATH}"
										atch_srno="{ATCH_SRNO}" use_intt_id="{USE_INTT_ID}" rgsr_nm="{RGSR_NM}"
										editor_srno="{EDITOR_SRNO}" file_type="{FILE_TYPE}" file_size="{data_file_size}"
										...
										<div class="all-file-name all-file-round-bottom-section-1 js-mouseover"
											mouseover-text="{mouseover-text}">{ORCP_FILE_NM}
										</div>
									</li>
								</ul>
								...
								<ul id="listTypeFileItem" style="display:none;">
									<li class="js-file-list js-selectable ui-selectee {download_yn}"
										...
										img_path="{IMG_PATH}" use_intt_id="{USE_INTT_ID}" rgsr_nm="{RGSR_NM}"
										editor_srno="{EDITOR_SRNO}" file_type="{FILE_TYPE}" file_size="{data_file_size}"
										rgsn_dttm="{RGSN_DTTM}" file_index_code="{file_index_code}"
										...
										<div class="all-file-list-name-type-4-1"><strong
												class="js-list-file-size">{file_size}</strong></div>
										<div class="all-file-list-name-type-2-1"><strong class="js-mouseover"
												mouseover-text="{RGSR_NM}">{RGSR_NM}</strong></div>
										<div class="all-file-list-name-type-3-1"><strong
												class="js-all-file-dttm">{date}</strong></div>
										<div class="js-file-menu all-file-plus-icon-image-type-1"
											style="display: none;"></div>
									</li>
								</ul>
								<ul id="listTypeFolderItem" style="display:none;">
									<li id="list-{folder-key}" class="js-file-list js-folder js-selectable ui-selectee"
										colabo-srno="{colabo-srno}" file-fld-srno="{file-fld-srno}"
										up-file-fld-srno="{up-file-fld-srno}">
								...
								<ul id="fileLayerTitleItem" class="js-file-items-class">
									<a href="#" class="js-file-header" project-srno="{project-srno}"
										file-fld-srno="{file-fld-srno}">
										<em class="flow-content-circle-type-1 project-color {project-color}"
											{project-color-display}=""></em>
											...
											<div class="flow-project-make-2">
												<div class="flow-project-popup-8 js-file-move-popup">
														...
														<ul id="moveFilePopupUl">
															<li id="movePopupProject"
																...
																<div class="file-folder-div">
																	<em
																		class="flow-content-circle-type-1 {project-color}"></em>
																	{project-title}
																	<a href="#"
													...
													<div class="flow-pop-button-type-2">
														...
														<a href="#">
															<div class="js-move-file-success flow-pop-sub-button-2">확인
															</div>
														</a>
													</div>
												</div>
								...
								<div id="fileMovePopupLiItem" class="d-none">
									<li class="file-folder js-move-file-li {popup-depth-class} {current-folder}"
										colabo-srno="{colabo-srno}" file-fld-srno="{file-fld-srno}"
										up-file-fld-srno="{up-file-fld-srno}" data-depth="{folder-depth}">
										<div class="file-folder-div">
								...
								<div id="countLayerItem" class="d-none">
									<div class="js-file-count-layer all-file-alert-type-2"><span><span
												class="js-count-text">{count}</span>개 파일/폴더를 선택되었습니다.</span><em
											class="js-all-cancle-button">선택
											취소</em></div>
								</div>
							</div>
								...
								<div class="all-schedule">
									<div class="btns-wr">
										<div class="project-search-area all-file-header-type-3">
											<div class="project-search">
												<i class="icons-search"></i>
												<input type="text" placeholder="일정 제목을 검색해주세요!"
										...
										<div class="btns-area">
											...
											<button id="scheduleAdd" type="button" class="collect-add-button"
												data-post-code="2"></button>
										</div>
									</div>
					...
					<div id="openProjectLayer" class="small-style-wrap d-none" style="display: none;">
						<div class="open-search-area">
							<div class="project-search-area all-file-header-type-3">
								<div class="project-search">
									<i class="icons-search"></i>
									<input id="openProjectSearchInput" type="text" placeholder="검색어를 입력해주세요"
												...
												<li class="js-period-type-search-filter">
													...
													<div class="condition-cell">
														<ul class="target-select-group">
															<li>
																<input type="radio" name="period-type" id="searchToday"
																	class="radio-input">
																<label for="searchToday"
																	class="js-period-type radio-label-checkbox"
																	data-code="today">오늘</label>
															</li>
															<li>
																<input type="radio" name="period-type"
																	id="searchOneWeek" class="radio-input">
																<label for="searchOneWeek"
																	class="js-period-type radio-label-checkbox"
																	data-code="week">
																	7일
																</label>
															...
															<li>
																<input type="radio" name="period-type"
																	id="searchOneMonth" class="radio-input">
																<label for="searchOneMonth"
																	class="js-period-type radio-label-checkbox"
																	data-code="month">
																	1개월
																</label>
															...
															<li>
																<input type="radio" name="period-type"
																	id="searchThreeMonth" class="radio-input">
																<label for="searchThreeMonth"
																	class="js-period-type radio-label-checkbox"
																	data-code="thirdMonth">
																	3개월
																</label>
															...
															<li>
																<input type="radio" name="period-type"
																	id="searchSixMonth" class="radio-input">
																<label for="searchSixMonth"
																	class="js-period-type radio-label-checkbox"
																	data-code="sixthMonth">
																	6개월
																</label>
															</li>
															<li>
																<input type="radio" name="period-type"
																	id="searchOneYear" class="radio-input">
																<label for="searchOneYear"
																	class="js-period-type radio-label-checkbox"
																	data-code="year">
																	1년
																</label>
													...
													<div class="condition-cell">
														<ul class="target-select-group">
															<li class="js-total-tmpl-type">
																<input type="radio" name="tmpl-type"
																	id="searchTargetTotalTmplType" class="radio-input">
																<label for="searchTargetTotalTmplType"
																	class="js-tmpl-type radio-label-checkbox"
																	data-code="">전체</label>
															</li>
															<li>
																<input type="radio" name="tmpl-type"
																	id="searchTargetWrite" class="radio-input">
																<label for="searchTargetWrite"
																	class="js-tmpl-type radio-label-checkbox"
																	data-code="1">글</label>
															</li>
															<li>
																<input type="radio" name="tmpl-type"
																	id="searchTargetTask" class="radio-input">
																<label for="searchTargetTask"
																	class="js-tmpl-type radio-label-checkbox"
																	data-code="4">업무</label>
															</li>
															<li>
																<input type="radio" name="tmpl-type"
																	id="searchTargetCalendar" class="radio-input">
																<label for="searchTargetCalendar"
																	class="js-tmpl-type radio-label-checkbox"
																	data-code="3">일정</label>
															</li>
															<li>
																<input type="radio" name="tmpl-type"
																	id="searchTargetTodo" class="radio-input">
																<label for="searchTargetTodo"
																	class="js-tmpl-type radio-label-checkbox"
																	data-code="2">할 일</label>
															</li>
															<li class="js-remark-tmpl-type">
																<input type="radio" name="tmpl-type"
																	id="searchTargetRemark" class="radio-input">
																<label for="searchTargetRemark"
																	class="js-tmpl-type radio-label-checkbox"
																	data-code="-1">댓글</label>
															</li>
														</ul>
													</div>
												</li>
						...
						<div class="main-sub-header">
							<div class="public-project-header">
								<button id="leftArrowButton" type="button" class="public-arrow-btn left"
									style="display: none">
								</button>
								<button id="rightArrowButton" type="button" class="public-arrow-btn right"
									style="display: none">
								</button>
					...
					<div id="allPostsLayer" class="me-post-wrap layer-scroll d-none" style="display: none;">
						<div class="my-search-area">
							<div class="project-search-area all-file-header-type-3">
								<div class="project-search">
									<i class="icons-search"></i>
									<input id="allPostsSearchInput" type="text" placeholder="검색어를 입력해주세요!"
										class="project-search-input" autocomplete="off" maxlength="50">
									<button id="allPostsDetailSearchTopButton" type="button"
										class="search-set-button">옵션</button>
									<div id="allPostsDetailSearchLayer" class="name-type-seach-popup d-none"
								...
								<button type="button"
									class="js-search-back-button js-all-posts-back result-back-button d-none"><i
										class="icons-back"></i> 돌아가기</button>
							</div>
						</div>
						...
						<div class="js-post-search-result all-search-section d-none me-post-wrap"
							data-search-area-code="">
							<div class="all-search-container">
								<div class="all-search-content">
									<div class="js-result-input-area project-search-area all-file-header-type-3"
										style="margin-top: 20px; display: none">
										<div class="project-search">
											<i class="icons-search"></i>
											<input type="text" placeholder="검색어를 입력해주세요!" class="project-search-input"
												autocomplete="off" maxlength="50">
											<button id="projectDetailSearchTopButton" type="button"
												class="js-detail-search-filter-button search-set-button">옵션</button>
											<div class="js-detail-search-filter-layer name-type-seach-popup d-none"
									...
									<button type="button"
										class="js-search-back-button js-detail-back result-back-button d-none"><i
											class="icons-back"></i> 돌아가기</button>
									<div id="postSearchArea" class="search-result-group">
										<div class="search-title-area">
											<span class="search-result-title">전체</span>
											<span id="allPostsSearchCount"
					...
					<a>히스토리</a>
							...
							<div id="projectCollectionCount" class="js-collection-count project-num-wrap"
								style="display: none;">
								<span>건수 : </span>
						...
						<div id="detailCollectView" class="detail-collect-view background-white d-none"
							style="display: none;">
							<div id="mainScroll" class="detail-collect-group type3 padding-left-right-30">
								...
								<div class="allFileLayer full-width small-style-wrap-2 d-none" style="display: none;">
									...
									<ul id="boardTypeFileItem" style="display:none;">
										<li class="js-file-board js-selectable ui-selectee {download_yn}"
											rand_key="{RAND_KEY}" thum_img_path="{THUM_IMG_PATH}" width="{WIDTH}"
											height="{HEIGHT}" orcp_file_nm="{DATA_ORCP_FILE_NM}"
											colabo_srno="{COLABO_SRNO}" colabo_commt_srno="{COLABO_COMMT_SRNO}"
											img_path="{IMG_PATH}" atch_srno="{ATCH_SRNO}" use_intt_id="{USE_INTT_ID}"
											rgsr_nm="{RGSR_NM}" editor_srno="{EDITOR_SRNO}" file_type="{FILE_TYPE}"
											...
											<a href="#">
												<div class="file-extension {view_type_class_name}" {thumbnail_url}="">
												</div>
											</a>
											<div class="all-file-name all-file-round-bottom-section-1 js-mouseover"
												mouseover-text="{mouseover-text}">{ORCP_FILE_NM}
									...
									<ul id="listTypeFileItem" style="display:none;">
										<li class="js-file-list js-selectable ui-selectee {download_yn}"
											...
											height="{HEIGHT}" orcp_file_nm="{DATA_ORCP_FILE_NM}"
											colabo_srno="{COLABO_SRNO}" colabo_commt_srno="{COLABO_COMMT_SRNO}"
											atch_srno="{ATCH_SRNO}" img_path="{IMG_PATH}" use_intt_id="{USE_INTT_ID}"
											rgsr_nm="{RGSR_NM}" editor_srno="{EDITOR_SRNO}" file_type="{FILE_TYPE}"
											file_size="{data_file_size}" rgsn_dttm="{RGSN_DTTM}"
											file_index_code="{file_index_code}" project_title="{PROJECT_TITLE}">
											<div class="all-file-list-name-type-1-1 ellipsis">
												<em class="all-file-type-check"></em>
												<div class="all-file-type-icon-wrap-1">
													<div class="file-extension {view_type_class_name}"></div>
											...
											<div class="flow-project-make-1">
												<div class="flow-project-make-2">
													<div class="flow-project-popup-8 js-file-move-popup">
														...
														<div class="flow-pop-button-type-2">
															<a href="#">
																<div class="js-class-button flow-pop-sub-button-1">취소
																</div>
															</a>
															<a href="#">
																<div class="js-move-file-success flow-pop-sub-button-2">
																	확인</div>
															</a>
														</div>
													</div>
										...
										<ul class="history-group">
											<li class="alarm-{COLABO_COMMT_SRNO} js-alarm-item {not-read}"
												...
												<div class="all-text-wrap-type-1">
													<div class="all-text-wrap-type-2"><i class="{emojiIcon}"></i>{msg}
													</div>
													<div class="all-text-wrap-type-3">{contents}</div>
													<div class="all-text-wrap-type-3">
														<span><em
																class="all-setup-icon-type-1 {img-yn}"></em>이미지</span><span><em
							...
							<div class="js-detail-wrap-area small-style-wrap">
								...
								<section id="postTimeline" class="project-detail-container">
									<div class="project-search-area all-file-header-type-3">
										<div class="project-search">
											<i class="icons-search"></i>
											<input id="projectSearchInput" type="text" placeholder="검색어를 입력해주세요"
												class="project-search-input" autocomplete="off" maxlength="50">
											<button id="projectDetailSearchTopButton" type="button"
												class="js-detail-top-search-button search-set-button">
												옵션
											</button>
											<div id="projectDetailSearchLayer" class="name-type-seach-popup d-none"
									...
									<div id="projectFeedArea" class="detail-section feed-section">
										...
										<div class="feed-content">
											<button id="postMoreBtn" type="button" class="more-btn"
												style="display: none"><i></i><i></i><i></i></button>
											...
											<div id="participantScrollArea"
												...
												<div id="joinParticipantsArea" class="participants-content d-none">
													<span class="participants-title">
														<em>가입 신청자</em>
														<span id="joinParticipantsCount"
															class="number-of-participants"></span>
													</span>
						...
						<div id="pinPostItem" class="d-none">
							<li id="pin-{post-srno}" class="js-pin-item" data-post-srno="{post-srno}"
								data-project-srno="{colabo-srno}">
								<a href="#">
									<div class="fixed-kind">
										<i class="icons-{post-gb}"></i>
										<span>{post-name}</span>
			...
			<article id="organizationLayer" class="side-wr" style="display:none">
				...
				<div class="side-contents">
					...
					<div id="orgSearch" class="all-setup-type-2">
						<i class="icons-search"></i>
						<input id="organizationInput" type="text" class="all-setup-input-type-1"
							placeholder="이름 소속 연락처 내선 검색" autocomplete="off">
					</div>
					<div class="group-tree-wrap-1 coperate-section-position-fix-1 js-group-tree-wrap">
				...
				<div id="emplArea" class="sub-drag-section-2" style="display:none">
					...
					<div class="sub-drag-header-type-2">
						<span class="dvsn-name" id="emplList-dvsnName"></span>
						<span id="resultSearch" class="empl-search-text d-none">검색 결과</span>
						<a id="emplAreaCloseBtn" href="#" class="group-close-type-1"></a>
					</div>
				...
				<div id="organizationItem" style="display:none">
					<li class="department-item" dvsn-cd="{dvsn-cd}" depth="{depth}" hgrn-dvsn-cd="{hgrn-dvsn-cd}"
						{margin-style}="">{group-icon}
						<em class="{button-class}"></em>
						<span style="cursor:pointer"
							class="group-tree-position-fix-type-{last-code} department-name group-tree-position-fix-type-1 {active}">{dvsn-nm}</span>
						<a href="#" class="js-dvsn-select coperate-check-type-1 d-none" {right-style}=""></a>
						<em class="{root-dvsn-line}"></em>
					</li>
				</div>
				...
				<div id="emplListItem" style="display:none">
					<li class="js-participant-item" data-id="{USER_ID}" rcvr_cd="{USER_ID}" rcvr_gb="U" id="{id}"
						profile-image="{PRFL_PHTG}">
						<div class="mini-mode-text-sub-area-1">
							<div class="mini-mode-main-picture-1" {image}="">
							</div>
							<div class="mini-mode-area-list-type-1">
								<p><strong id="name">{FLNM}</strong>{JBCL_NM}</p>
								<p class="mini-mode-text-gray-1"><span>{CMNM}</span> {DVSN_NM}</p>
							</div>
						</div>
						<a href="#" id="miniOrganizationChatButton" class="mini-mode-circle-type-1 js-participant-chat">
							<i class="icons-chat"></i>
						</a>
						<div id="selectMemberBtn" class="my-check-2 select-member-btn d-none"></div>
					</li>
				</div>
			</article>
			...
			<article id="alarmLayer" class="side-wr d-none">
				...
				<div class="side-contents">
					...
					<div class="all-setup-type-2">
						<i class="icons-search"></i>
						<input id="alarmSearchInput" type="text" class="all-setup-input-type-1" placeholder="검색"
							autocomplete="off">
						<a href="#" id="alarmSearchFilterTopButton" class="all-setup-detail-text-1">옵션</a>
						<div id="alarmSearchFilterLayer" class="popup-filter-type-1 d-none">
							<div class="js-project-title js-filter-item setup-detail-type-1 setup-active-type-1"
								data-num="0"><a href="#"><span>프로젝트명</span><em></em></a>
							</div>
							<div class="js-contents js-filter-item setup-detail-type-1 setup-active-type-1"
								data-num="1"><a href="#"><span>내용</span><em></em></a></div>
							<div class="js-register-id js-filter-item setup-detail-type-1 setup-active-type-1"
								data-num="2"><a href="#"><span>작성자</span><em></em></a></div>
						</div>
					</div>
				...
				<div id="alarmItem" class="d-none">
					<li class="alarm-{COLABO_COMMT_SRNO} js-alarm-item {not-read}" colabo_srno="{COLABO_SRNO}"
						colabo_commt_srno="{COLABO_COMMT_SRNO}" colabo_remark_srno="{COLABO_REMARK_SRNO}"
						alarm_action="{ALARM_ACTION}" alarm_status="{ALARM_STATUS}" toast_msg="{msg}"
						toast_cntn="{contents}">
						<div class="all-setup-picture-type-1" {profile}=""></div>
						<div class="all-text-wrap-type-1">
							...
							<div class="all-text-wrap-type-2 alarm-tit-ellipsis"><i class="{emojiIcon}"></i>{msg}</div>
							<div class="all-text-wrap-type-3">{task-name}{contents}
							</div>
							<div class="all-text-wrap-type-3">
								<span {img-display}="">
									<em class="all-setup-icon-type-2"></em>이미지</span>
								<span {file-display}="">
									<em class="all-setup-icon-type-1"></em>파일</span>
							</div>
						</div>
					</li>
				</div>
				...
				<div id="projectAlarmItem" class="d-none">
					<li id="unread-{COLABO_COMMT_SRNO}" class="not-read-alarm-item" colabo_srno="{COLABO_SRNO}"
						colabo_commt_srno="{COLABO_COMMT_SRNO}" colabo_remark_srno="{COLABO_REMARK_SRNO}"
						alarm_action="{ALARM_ACTION}" alarm_status="{ALARM_STATUS}" toast_msg="{msg}">
			...
			<article id="chattingLayer" class="side-wr d-none">
				<div class="menu-top">
					<strong>채팅</strong>
					<button type="button" class="js-allChat-alarm alarm on js-mouseover js-button-tooltip"
						mouseover-text="">
						<i class="icon-alarm"></i>
					</button>
				...
				<div class="side-contents">
					...
					<div class="all-setup-type-2">
						<i class="icons-search"></i>
						<input id="chattingSearchInput" type="text" class="all-setup-input-type-1"
							placeholder="채팅방 또는 이름 검색" autocomplete="off">
					</div>
					<ul id="chatMemberList" class="participants-list contact-area d-none"></ul>
					<ul id="chattingUl" class="participants-list chat-list-area chat-list scroll-mask"></ul>
				</div>
				<div id="chattingItem" class="d-none">
					<li id="chatting-{ROOM_SRNO}" class="js-chatting-item" data-room-srno="{ROOM_SRNO}"
						data-bg-color-cd="{BG_COLOR_CD}" pin-yn="{PIN_YN}">
						<div class="mini-mode-text-sub-area-1">
							<div class="mini-mode-main-picture-1 mini-mode-chattng-type profile {profile-display-type}">
								{profile}
							</div>
							<div class="mini-mode-area-list-type-1">
								<p>
									<strong class="js-title">{ROOM_NM}</strong>
									<span class="mini-mode-chattng-type-2"
										{sendience-cnt-display}="">({SENDIENCE_CNT})</span>
									<i class="no-alarm mini-mode-chattng-icon-type-1" {no-alarm-display}=""></i>
									<i class="pin mini-mode-chattng-icon-type-2" {pin-display}=""></i>
								</p>
								<p class="mini-mode-text-gray-1"><i {img-display}=""
										class="js-image-icon all-setup-icon-type-2"></i><i {file-display}=""
										class="js-file-icon all-setup-icon-type-1"></i><span><a
											class="js-cntn">{CNTN}</a></span></p>
							</div>
							<div class="mini-mode-chattng-type-3">
								<div class="mini-mode-chattng-type-text-1 not-read-count" {not-read-display}="">
									{NOT_READ_CNT}</div>
			...
			<div id="projectMakeLayer" class="flow-all-background-1 d-none back-area">
					...
					<div class="flow-project-make-2 back-area">
						<div class="input-main-layer flow-project-popup-1 d-block">
							<div class="flow-project-header-1">
								...
								<button class="js-service-helper js-mouseover" service-code="CREATE"> <i
										class="icons-help"></i></button>
								<a href="#" class="js-project-make-close-btn flow-close-type-1 close-event"></a>
							</div>
							<div class="flow-content scroll-mask">
								<div class="flow-content-1">
									<input id="projectTitleInput" type="text" placeholder="제목을 입력하세요." maxlength="50"
										autocomplete="off" data-empty-msg="제목을 입력하세요."
										data-over-msg="제목은 50자 이하로 입력하세요." data-required-yn="Y">
								</div>
								<div class="flow-content-2">
									<textarea id="projectContentsInput" placeholder="프로젝트에 관한 설명 입력 (옵션)"
										data-required-yn="N"></textarea>
								</div>
								<div class="flow-content-3">
									옵션
									<button class="js-service-helper js-mouseover" service-code="OPTION"> <i
											class="icons-help"></i></button>
								</div>
								<a href="#">
								</a>
								<div class="open-yn check-setting flow-content-4" style="display: none;"><a>
										<em></em>
										회사 공개 프로젝트 설정
									</a>
									...
									<a href="#">
										<button type="button" class="toggle-button check-area js-project-open-toggle">
											<!-- active 클래스로 제어  -->
											<i class="handle"></i>
										</button>
									</a>
								...
								<div class="manager-permit-yn check-setting flow-content-5"><a>
										<em></em>
										관리자 승인 후 참여 가능
									</a>
									<button class="js-sendience-service-helper js-mouseover"
									...
									<a href="#">
										<button type="button" class="toggle-button check-area js-project-toggle">
											<!-- active 클래스로 제어  -->
											<i class="handle"></i>
										</button>
									</a>
								...
								<a href="#">
									<div class="more-option-button flow-content-6">
										<em class="main-return-event"></em>
										추가 설정
										<div class="flow-sub-content-1">
											<span class="category-name"></span><em></em>
											<i></i>
										</div>
									</div>
								</a>
						...
						<div class="open-category-layer flow-project-popup-2 d-none">
							<div class="flow-project-header-1">
								<a href="#"><em class="main-return-event"></em></a>
								회사 공개 프로젝트 카테고리 설정
								<a href="#" class="flow-close-type-1 close-event"></a>
							...
							<div class="flow-content scroll-mask">
								<div class="more-option-group">
									<dl class="flow-more-option-1 write-option">
										<dt>글 작성 권한</dt>
										<dd class="check-area" data-manager-write-yn="N"><a href="#"><em></em>전체</a>
										</dd>
										<dd class="check-area" data-manager-write-yn="Y"><a href="#"><em></em>
												프로젝트 관리자만</a></dd>
									</dl>
									<dl class="flow-more-option-1 remark-write-option">
										<dt>댓글 작성 권한</dt>
										<dd class="check-area" data-manager-remark-write-yn="N"><a
												href="#"><em></em>전체</a>
										</dd>
										<dd class="check-area" data-manager-remark-write-yn="Y"><a href="#"><em></em>
												프로젝트 관리자만</a></dd>
									</dl>
									<dl class="flow-more-option-1 lookup-option">
										<dt class="clearfix">
											...
											<span class="flow-more-option-alert-txt">
												프로젝트 생성 후에는 권한 변경이 불가능 합니다
											</span>
										</dt>
										<dd class="check-area" data-manager-lookup-yn="N"><a href="#"><em></em>전체</a>
										</dd>
										<dd class="check-area" data-manager-lookup-yn="Y"><a href="#"><em></em>
												프로젝트 관리자 + 글 작성 본인만</a>
										</dd>
									</dl>
									<dl class="flow-more-option-3 download-option">
										...
										<dd class="check-area" data-manager-download-yn="N"><a href="#"><em></em>전체</a>
										</dd>
										<dd class="check-area" data-manager-download-yn="Y"><a href="#"><em></em>
												프로젝트 관리자 + 글 작성 본인만</a>
										</dd>
									</dl>
								</div>
			...
			<div id="inviteLayer" class="flow-all-background-1 d-none">
				<div class="window_top rigVer" style="">
					...
					<div class="dragArea" style="display: list-item; -webkit-app-region: drag;"></div>
				</div>
				<div class="flow-project-make-1">
					<div class="flow-project-make-2">
						<div id="inviteMainLayer" class="detail-popup-type-1" style="display:none">
							<div id="copyLinkAlam" class="detail-alarm-type-1 d-none">초대링크를 클립보드에 복사했습니다.</div>
							<div class="detail-popup-header-1">
								<span id="inviteTitle" class="invite-title ellipsis"><i
										class="project-color color-code-9"></i></span>
								<a class="closeInviteLayerBtn" href="#"><em></em></a>
							</div>
							<ul id="inviteUl">
								<li id="openTeamInvite">
									<a href="#">
										...
										<div class="detail-popuplist-type-1">
											<span>회사 직원 초대</span>
											<em>회사 직원 또는 조직도를 확인하고 초대할 수 있습니다.</em>
										</div>
									</a>
								</li>
								<li id="openSendienceInvite">
									<a href="#">
										...
										<div class="detail-popuplist-type-1">
											<span>프로젝트 참여자</span>
											<em>프로젝트를 함께 했던 사람을 초대할 수 있습니다.</em>
										</div>
									</a>
								</li>
								<li id="openSendEml">
									<a href="#">
										...
										<div class="detail-popuplist-type-1">
											<span>이메일 초대장 발송</span>
											<em>초대장을 이메일로 발송할 수 있습니다.</em>
										</div>
									</a>
								</li>
								<li id="copyInviteLink">
									<a href="#">
						...
						<div id="sendInviteEmlLayer" class="send-invite-email name-type-seach-popup-type-1"
							style="display:none">
							<div class="name-type-seach-popup-header-type-1 margin-bottom-20">
								<a href="#"><em class="returnMainBtn"></em></a>
								<span>이메일 초대장 발송</span>
							...
							<div class="invite-email-area scroll-mask">
								...
								<a id="addEmail" href="#" class="email-plus-type-1"><em></em><span>이메일 추가</span></a>
								<div class="flow-email-plus-type-1">초대내용 입력</div>
								<div class="flow-email-bottom-section-1">
									<div id="inviteMsg" contenteditable="true" class="flow-email-bottom-text-1">
										<p>플로우로 업무관리, 채팅, 파일공유를 한 곳에서! <br>아이폰, 안드로이드는 물론 PC에서도 사용해보세요.</p>
									</div>
								</div>
							</div>
							<div class="flow-pop-button-type-1">
						...
						<div id="teamInviteLayer" class="name-type-seach-popup-type-1" style="display:none">
							<div class="name-type-seach-popup-header-type-1">
								<a href="#"><em class="returnMainBtn"></em></a>
								<span id="teamInviteHeader">회사 직원 초대</span>
								<button class="btn-close closeInviteLayerBtn"><i class="icons-close-1"></i></button>
							</div>
							<div class="all-setup-type-2">
								<i class="icons-search"></i>
								<input type="text" id="teamInviteSearch" class="coperate-input-type-1"
									placeholder="이름 소속 연락처 내선 검색" autocomplete="off">
							</div>
							...
							<div id="teamInviteArea"
								...
								<ul id="inviteMemberList" class="participants-list invite-member-list">
								</ul>
							</div>
							<div id="inviteEmplArea"
								...
								<div class="sub-drag-header-type-2">
									<span id="emplList-dvsnName"></span>
									<span id="resultSearch" class="empl-search-text d-none">검색 결과</span>
									<a id="emplAreaCloseBtn" href="#" class="group-close-type-1"></a>
								</div>
								<div class="sub-drag-picture-section-1">
			...
			<div id="tempEmailItem" style="display:none">
				<div class="input-email-type-wrap-1 emailItem">
					<input type="text" class="input-email-type-1 emailItemInput" placeholder="example@flow.team"
						data-valid="email" maxlength="50" data-required-yn="Y" data-empty-msg="이메일을 작성해주세요!"
						data-over-msg="이메일은 50자이내로 작성해주세요!" data-un-valid-msg="올바른 이메일을 작성해주세요!">
					<a class="deleteEmail" href="#"></a>
				</div>
			</div>
			<div id="selectMemberItem" style="display:none">
				<li rcvr_cd="{rcvr-cd}" rcvr_gb="{rcvr-gb}" id="{id}">
					<i {profile}=""></i>
					<a href="#">
						<span class="member-name ellipsis">{name}</span>
					</a>
					<a href="#">
						<em class="deleteMemberItem"></em>
					</a>
				</li>
			</div>
			...
			<div id="mySettingPopup" class="flow-all-background-1 d-none zx-9">
				<div class="flow-project-make-1">
					<div class="flow-project-make-2">
						<div id="innerMySettingPopup" class="my-layer-type-3">
							<div class="my-layer-header">
								...
								<div class="my-left-style">
									<ul class="my-popup-left-header" id="mySettingLeftMenu">
										<li class="js-my-setting-left"><a id="accountSettingBtn" href="#"><em
													class="my-color-type-2"></em><em class="my-type-text-1">계정 설정
												</em></a>
										</li>
										<li class="js-my-setting-left"><a id="preferencesBtn" href="#"><em
													class="my-color-type-1"></em><em class="my-type-text-2">알림
													설정</em></a>
										</li>
										<li class="js-my-setting-left"><a id="projectSettingBtn" href="#"><em
													class="my-color-type-1"></em><em class="my-type-text-2">디스플레이
													설정</em></a>
										</li>
										<li class="js-my-setting-left"><a id="deviceManagementBtn" href="#"><em
													class="my-color-type-1"></em><em class="my-type-text-2">보안 설정
												</em></a>
										</li>
										<li class="js-my-setting-left"><a id="outServiceBtn" href="#"><em
													class="my-color-type-1"></em><em class="my-type-text-2">외부서비스
													연동</em></a></li>
										<li class="js-my-setting-left" style="display:none"><a id="downloadAppBtn"
												href="#"><em class="my-color-type-1"></em><em
													class="my-type-text-2">다운로드</em></a>
										</li>
										<li id="paymentLeftMenu" class="js-my-setting-left" style="display:none"><a
												id="paymentInfoBtn" href="#"><em class="my-color-type-1"></em><em
													class="my-type-text-2">결제 정보</em></a>
										</li>
									</ul>
								</div>
							...
							<div id="accountSettingLayer" class="js-my-scroll-layer my-over-style d-none">
								<div class="my-right-style adjust">

									<a id="companyParticipationBtn" class="btn-company-participation" href="#"
										style="display: block;">기존회사에 참여하기</a>

									<ul>
										<li id="upgradeBanner" class="upgrade-area adjust" style="display: block;">
											<strong><span id="bannerUserNm"></span>님에게 꼭 필요한 기능들이 준비되어 있습니다!</strong>
										...
										<li class="edit-input adjust">
											...
											<div class="editor-mode d-none">
												<div class="my-right-list-2 my-type-text-1">
													...
													<div class="btn-fr-wrap"><a href="#">
															<div class="my-button-cc cancel-change">취소</div>
														</a><a href="#">
															<div class="js-account-set-button js-account-set-button my-button-ok change-ok"
																gubun="1">확인</div>
														</a></div>
												</div>
											</div>
										...
										<li class="edit-input adjust">
											...
											<div class="editor-mode d-none">
												<div class="my-right-list-2 my-type-text-1">
													...
													<input id="editor_phoneNum" type="text" class="my-text-input-1"
														autocomplete="off" data-valid="number" maxlength="20"
														data-over-msg="" data-un-valid-msg="전화번호는 숫자만 입력해주세요!"
										...
										<li class="edit-input adjust">
											...
											<div class="editor-mode d-none">
												<div class="my-right-list-2 my-type-text-1">
													...
													<input id="editor_companyPhoneNum" class="my-text-input-1"
														type="text" autocomplete="off" maxlength="20" data-over-msg=""
														data-valid="number" data-un-valid-msg="전화번호는 숫자만 입력해주세요!"
														style="min-width: 150px;">
													<div class="btn-fr-wrap">
														<a href="#">
															<div class="my-button-cc cancel-change">취소</div>
										...
										<li class="edit-input js-email-set adjust">
											...
											<div class="editor-mode d-none">
												<div class="my-right-list-2 my-type-text-1">
													<input id="editor_user_email" type="text" autocomplete="off"
														data-valid="email" maxlength="50" data-empty-msg="이메일을 작성해주세요!"
														data-over-msg="" data-un-valid-msg="올바른 이메일을 작성해주세요!">
													<div class="btn-fr-wrap"><a href="#">
															<div class="my-button-cc cancel-change">취소</div>
														</a><a href="#">
															<div class="js-account-set-button my-button-ok change-ok"
										...
										<li class="edit-input adjust" id="passwordArea" style="display: block;">
											...
											<div class="editor-mode d-none">
												<ul>
													<li>
														<div class="my-right-list-1">비밀번호</div>
														<div class="my-right-list-2 edit-password"><a href="#"></a><span
																class="my-txt-t-1">비밀번호는 영문, 숫자 포함 6자리 이상이어야 합니다.</span>
															<div class="btn-fr-wrap"><a href="#">
													...
													<li>
														...
														<div class="my-right-list-2">
															...
															<input type="password" id="myPassword"
																class="my-input-password-2" autocomplete="off"
																data-required-yn="Y" maxlength="20"
																data-valid="password" data-empty-msg="비밀번호를 입력해주세요"
																data-over-msg=""
																data-un-valid-msg="6자 이상의 영문,숫자를 입력하세요."
																placeholder="비밀번호를 입력해주세요"></div>
													</li>
													<li>
														<div class="my-right-list-1"></div>
														<div class="my-right-list-2">
															...
															<input type="password" class="my-input-password-2"
																...
																data-un-valid-msg="6자 이상의 영문,숫자를 입력하세요."
																placeholder="비밀번호를 다시 입력해주세요"></div>
													</li>
												</ul>
											</div>
										</li>
										<li class="edit-input adjust" id="statusMessageMenu">
											<div>
												...
												<div class="read-mode d-block">
													<div id="statusMessage" class="my-right-list-2 status-message">
													</div>
												...
												<div class="editor-mode d-none">
													<div class="my-right-list-2 my-type-text-1">
														<input id="editor_statusMessage" type="text" autocomplete="off"
															maxlength="50">
														<div class="btn-fr-wrap"><a href="#">
																<div class="my-button-cc cancel-change">취소</div>
															</a><a href="#">
									...
									<button id="leaveFlowBtn" class="btn-leave" style="display: block;">탈퇴</button>
								</div>
							</div>
							...
							<div id="preferencesLayer" class="js-my-scroll-layer my-over-style d-none">
							...
							<div id="deviceManagementLayer" class="js-my-scroll-layer my-over-style-2 d-none">
								...
								<div class="my-right-style-3">
									<ul>
										<li style="display: none">
											...
											<div class="my-right-list-3 mgt-20"><span class="my-right-position-fix-1">좌측
													메뉴의 컬러 테마를 지정하실 수 있습니다.</span></div>
										</li>
										<li style="display: none">
											<div class="my-right-list-1"></div>
											<div class="my-right-list-4">
												<div class="my-right-check-dark">
													...
													<p>다크</p><a href="#">
														<div id="darkThemeSetting" class="my-check-2 theme-posion-fix">
														</div>
													</a>
												</div>
										...
										<li>
											...
											<div class="my-right-list-3"><span class="my-right-position-fix-1">프로젝트 만들기
													또는 초대 받았을때, 프로젝트의 색상을 지정합니다.</span></div>
										</li>
										<li>
											<div class="my-right-list-1"></div>
											<div class="my-right-list-2">
												<span class="my-right-position-fix-1">랜덤으로 설정</span>
												<a href="#">
										...
										<li>
											<div class="my-right-list-1"></div>
											<div class="my-right-list-2">
												<span class="my-right-position-fix-1">흰색으로 고정</span>
												<a href="#">
										...
										<li class="my-setting-favorite-project">
											...
											<div class="my-right-list-3 mgt-20"><span
													class="my-right-position-fix-1">프로젝트 즐겨찾기 시, 상단에 고정하도록 설정할 수
													있습니다.</span>
												<span id="resetBtn" class="btn-reset"><a href="#"
										...
										<li>
											<div class="my-right-list-1"></div>
											<div class="my-right-list-2">
												<span class="my-right-position-fix-1">
													즐겨찾기 사용
												</span>
												<a href="#">
										...
										<li>
											<div class="my-right-list-1"></div>
											<div class="my-right-list-2">
												<span class="my-right-position-fix-1">즐겨찾기 사용안함</span>
												<a href="#">
													<div id="notUseFavoritesSetting" class="my-check-2"></div>
												</a>
											</div>
										</li>
										<li>
										...
										<li>
											...
											<div class="my-right-list-2">
												언어
												<select id="langSetting" class="my-type-3">
				...
				<li>
				  ...
				  -->
							...
							<div id="downloadAppLayer" class="my-over-style d-none">
								<div class="my-right-style-3">
									<div class="my-right-inoutput">
										<div class="my-download-icon-type-4">
										</div>
										...
										<input id="phoneNumber" type="text" class="my-download-text-type-1">
										<a id="smsSendBtn" href="#" class="my-right-sevice-button-1">
											<div>문자 전송</div>
										</a>
									</div>
							...
							<div id="paymentInfoLayer" class="js-my-scroll-layer my-over-style" style="display:none">
								<div class="my-right-style-3">
									<div class="my-right-inoutput">
							...
							<div id="outServiceLayer" class="js-my-scroll-layer my-over-style-2 d-none">
								<div class="my-right-style-5">
									<div class="my-right-inoutput my-position-fix">
										<p>플로우와 연동하여 사용을 희망하는 서비스가 목록에 없으신가요? <br> 플로우 팀에게 희망 연동 서비스를 알려주세요!</p>

										<a id="serviceApplyBtn" href="#" class="my-right-sevice-button-1">
											<div>요청</div>
										</a>
									</div>
									<ul class="my-inoutput-list-type-1">
										<li>
											...
											<div class="my-inoutput-text-type-1">
												...
												<p class="my-inoutput-text-type-3 d-inline-block">
													플로우에 Zoom을 연동합니다</p>
												<a href="#" class="more-txt js-learn-details d-none"
													service-code="ZOOM">자세히 알아보기</a>
											</div>
											<a id="zoomConnectBtn" class="my-inoutput-button-type-1 js-connect-btn">
												<div>연동</div>
											</a>
										</li>
										<li>
											...
											<div class="my-inoutput-text-type-1">
												...
												<p class="my-inoutput-text-type-3"> 플로우에 Google Calendar을 연동합니다</p>
											</div>
											<a class="my-inoutput-button-type-3 js-connect-btn">
												<div>준비중</div>
											</a>
										</li>
									</ul>
		...
		<div id="allSendiencePopup" class="flow-all-background-1" style="display:none;">
			<div class="flow-project-make-1">
				<div class="flow-project-make-2">
					<div id="allSendienceLayer" class="project-invite-popup-1">
						...
						<div class="all-setup-type-2">
							<i class="icons-search"></i>
							<input type="text" id="allSendienceSearch" class="coperate-input-type-1"
								placeholder="참여자명으로 검색">
						</div>
						<div class="sub-drag-picture-section-1 overflow-scroll-type-1  scroll-mask">
		...
		<div id="imageViewerItem">
			<div class="image-viewer-wrap js-image-viewer-item d-none" tabindex="1" style="overflow:hidden;">
				<div class="image-viewer-header">
					<div class="image-title-area">
						<div class="image- title-top" style="color:white;">
							<span class="js-img-title image-title"></span>
						...
						<div class="image-title-bottom" style="color:#999;">
							<span class="image-user-name"></span>
							<span class="image-upload-date"></span>
						</div>
					</div>
					<a href="#" role="button" class="viewer-close-button">
						<span class="blind">close</span>
					</a>
				</div>
				<div class="js-container image-viewer-container">
					<a href="#" role="button" class="viewer-button left" data-img-idx="-1">
						<span class="blind">left</span>
					</a>
					<div class="image-group">
						<div class="js-img-back image-bg"></div>
					</div>
					<a href="#" role="button" class="viewer-button right" data-img-idx="1">
				...
				<div class="image-viewer-footer">
					...
					<div class="btn-editbox">
						...
						<a href="#" role="button" class="image-edit-btn plus">
							<span>확대</span></a>
						<a href="#" role="button" class="image-edit-btn minus">
							<span>축소</span></a>
						<a href="#" role="button" class="image-edit-btn autosize">
							<span>초기화</span></a>
					</div>
					<div class="btn-editbox right-fix">
						<a href="#" id="btnDownPic" class="viewer-save" data-langcode="CT927">저장</a>
						<a href="#" role="button" class="viewer-save" id="btnAllDownPic">
							전체 저장
						</a>
					</div>
				</div>
	...
	<div id="bottomToolList" class="bottom-tool-list">
		<div class="js-tool-item tool-item" id="quickGuideMenu" data-code="quick" style="display: block;">
			<button type="button" class="js-quick-button js-bottom-quick-button d-none btn-help-open"
				style="display: inline-block;">
				<span class="help-wr">
					<img src="/flow-renewal/assets/images/icons/help_center01.png" alt="고객센터 열기">
				</span>
				고객센터
			</button>
			<div class="js-bottom-quick-layer quick-guide quick-pop d-none" style="display: none;">
				<div class="quick-guide-header">
					<div class="quick-guide-title">
						플로우 쉽게 사용하기
					</div>
					<button type="button" class="js-quick-close btn-help-close" style="display: none;">
						<img src="/flow-renewal/assets/images/icons/help_center02.png" alt="고객센터 닫기">
					</button>
				</div>
				<div class="help-center">
					<div class="help-contents">
						...
						<div class="help-middle">
							<em class="helr-active">
								<img src="/flow-renewal/assets/images/icons/help_center04.png" alt="">
								<i class="active-on"></i>
							</em>
							<div class="help-txt">
								<p>플로우에 대해 궁금한 점을 남겨주세요!<br>최대한 빠르게 답변 드리겠습니다.</p>
								<p class="help-txt-sub">고객센터 운영시간 : 평일 9:00 ~ 18:00</p>
							</div>
						</div>
						<button type="button" class="js-btn-help-talk btn-help-talk">
							<i><img src="/flow-renewal/assets/images/icons/help_center03.png" alt=""></i>편하게
							소통하기</button>
				...
				<div class="quick-guide-contents">
					...
					<ul id="quickGuideList" class="quick-guide-list">
						<li><a target="_blank" class="quickGuideLi"
								href="https://blog.naver.com/madrascheck/222484670050"=""=""><em class="new">New </em>
								플로우 달라진 기능 확인하기 👀</a></li>

						<li><a target="_blank" class="quickGuideLi" href="https://flow.team/download.act"=""=""><em
									class="new">New </em>🌐New PC버전 다운로드</a></li>

						<li><a target="_blank" class="quickGuideLi"
								href="https://support.flow.team/hc/ko/articles/360056979552"=""="">🎓플로우 온라인 교육</a></li>

						<li><a target="_blank" class="quickGuideLi"
								href="https://support.flow.team/hc/ko/categories/4403605340557"=""="">🍯 FAQ - 플로우
								매뉴얼</a></li>

						<li><a target="_blank" class="quickGuideLi"
								href="https://support.flow.team/hc/ko/articles/4404358245645"=""="">🙋‍♂️직원들과 플로우 함께하기
								(직원 추가 방법)</a></li>

						<li><a target="_blank" class="quickGuideLi"
								href="https://forms.gle/W3VTPVxZgm9yUFgt5"=""="">✨새로운 플로우 설문조사 (+희망 기능 투표)</a></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="d-none">
		...
		<ul id="taskListProjectItem" class="d-none">
			<li id="{GUBUN}" colabo-srno="{COLABO_SRNO}" colabo-commt-srno="{COLABO_COMMT_SRNO}" class="js-gubun-li">
				<div class="js-gubun-button all-task-project">
					<span class="project-title">{GUBUN_NM}</span>
					<span class="project-task-count">{TASK_CNT}</span>
				</div>
		...
		<ul id="taskListItem" class="d-none">
			<li id="allTask-{COLABO_COMMT_SRNO}" class="task-item {LI_STTS}" data-project-srno="{COLABO_SRNO}"
				data-post-srno="{COLABO_COMMT_SRNO}" data-task-srno="{TASK_SRNO}" data-post-code="4">
				{COLUMN_LIST}
			</li>
		</ul>
		...
		<div id="taskListPriorityItem" class="d-none">
			<div class="js-priority task-item-cell {CELL_CLASS}">
				<div class="js-priority-span rank-span">
					<i class="{PRIORITY_ICON} small"></i>
					<span class="js-priority-text priority-text-cell ellipsis">
						{PRIORITY}</span>
				</div>
			</div>
		</div>
		...
		<div id="taskListTitleItem" class="d-none">
			<div class="task-item-cell task-name {CELL_CLASS}">
				<div class="js-post-title task-title ellipsis js-mouseover" mouseover-text="{TASK_NM}">{TASK_NM}
					<em class="subtask-item" {subtask-display}="">
						<i class="icons-subtask"></i>
						<span class="subtask-number">{SUBTASK_CNT}</span>
					</em>
				</div>
		...
		<div id="taskListWorkerItem" class="d-none">
			<div class="js-workers task-item-cell {CELL_CLASS}">
				<span class="js-mouseover" mouseover-text="{MOUSEOVER_WORKER_LIST}">
					<span class="js-worker-name manager ellipsis">{WORKER}</span>
					<span class="js-worker-count">{WORKER_COUNT}</span>
				</span>
			</div>
		</div>
		...
		<div id="taskListProgressItem" class="d-none">
			<div class="task-item-cell task-progress-bar {CELL_CLASS}">
				<span class="progress-bar">
					<span class="js-progress-bar {progress-class}" {progress}=""></span>
				</span>
			</div>
		</div>
				...
				<div class="flow-project-make-1 back-area">
					<div class="flow-project-make-2 back-area">
						<div id="sortLayer" class="project-invite-popup-1 task-view-popup">
							...
							<ul id="taskSortList" class="invite-popup-list-type-2 ui-sortable scroll-mask"></ul>
							<div class="flow-pop-button-type-1">
								<a href="#">
		...
		<ul id="taskSortPopupLiItem" style="display: none;">
			<li class="js-sort-li before_on" col-srno="{COL_SRNO}">
				<div class="task-set-item">
					...
					<span class="task-set-title">{COL_NM}</span>
					<button type="button" class="js-sort-button toggle-button {SORT_TITLE} {COL_CLASS}">
						<i class="handle"></i>
					</button>
				</div>
			</li>
	...
	<div id="inviteItem" class="d-none">
		<div class="invite-text-area">
			<span>{CNTN}</span>
			<span class="invite-time">{date}</span>
		</div>
	</div>
	<div id="postItem" class="d-none">
		<li id="post-{COLABO_COMMT_SRNO}" class="js-popup-before detail-item back-area" data-read-yn="{READ_YN}"
			data-project-srno="{COLABO_SRNO}" data-post-srno="{COLABO_COMMT_SRNO}"
			data-remark-srno="{COLABO_REMARK_SRNO}" data-rgsr-id="{RGSR_ID}" mngr-wryn="{mngr-wryn}"
			mngr-dsnc="{mngr-dsnc}" data-post-code="{post-code}" pin-yn="{PIN_YN}" status="{status-raw}"
			todo-done-percent="{TODO_DONE_PERCENT}" time="{start-date-time-raw}" data-code="{data-code}"
			data-post-url="{post-url}">
			<div class="js-post-nav list-item post-list-wrapper">
				<div class="fixed-list">
					<a href="#">
						<i class="js-indication display-new-indication" {alarm-display}=""></i>
						<div class="fixed-kind">
							<i class="icons-{post-gb}"></i>
							<span>{post-name}</span>
						</div>
						...
						<div class="post-list comment" {remark-display}="">
							<i class="icons-comment2"></i>
							<span class="js-remark-count">{remark-count}</span>
						</div>
						<div class="post-list-right">
							<div class="post-list name">{name}</div>
							<div class="post-list date">{date}</div>
							<div class="fixed-value">
								<span class="js-todo-state state request d-none"
									{todo-display}="">{TODO_DONE_PERCENT}</span>
								<span class="js-task-state state d-none {status-code}" {task-display}="">{status}</span>
								<div class="js-schedule-state date-time d-none" {schedule-display}="">
									<em class="date">{start-date}</em>
									<span>{start-time}</span>
								</div>
							</div>
			...
			<div class="js-post-nav card-item post-card-wrapper {post-gb} {subtask-gb}">
				...
				<div class="post-popup-header card-popup-header d-none">
					<h3 class="card-popup-title">
						<i id="projectTitleColor" class="project-color color-code-{BG_COLOR_CD}"></i>
						<span class="js-project-title-button">{COLABO_TTL}</span>
						<span class="subtask-title up-task-title js-up-task-button" {up-task-display}=""
							data-up-task-project-srno="{data-up-task-project-srno}"
							data-up-task-post-srno="{data-up-task-post-srno}" data-up-task-srno="{data-up-task-srno}">
							{UP_TASK_TTL}</span>
					</h3>
				...
				<div class="post-card-header">
					<div class="post-card-scroll">
						<div class="card-header-top">
							<div class="post-author js-post-author" data-author-id="{author-id}">
								<span class="thumbnail size40 radius16" {profile}=""></span>
								<dl class="post-author-info">
									<dt>
										<strong class="author ellipsis">{name}</strong>
										<em class="position ellipsis" {prfl-dvsn-display}="">{position}</em>
										<span class="date">{date}</span>
										<span class="post-security"> <i class="{security-class} js-mouseover"
												mouseover-text="{security-text}"></i></span>
									</dt>
									<dd class="{personal-yn}">
							...
							<div>
								<div class="post-option">
									...
									<button id="pinToTopBnt" class="fixed-btn {PIN_USE_YN} {PINNED}"
										{pin-btn-display}="">
										<!-- fixed-btn on class -->
										<span class="blind">상단 고정 등록</span>
									</button>
									<button class="js-setting-button set-btn" {menu-button-display}="">
										<span></span>
										<span></span>
										<span></span>
									</button>
									<ul class="js-setting-ul js-setting-layer setup-group d-none">
										<li class="js-setting-item" data-code="modify" {menu-modify-display}="">
											<a href="#"> <i class="icons-write"></i>수정</a>
										</li>
										<li class="js-setting-item" data-code="delete" {menu-delete-display}="">
										...
										<li class="js-setting-item" data-code="url" {menu-url-display}="">
						...
						<div class="card-header-bottom {no-title}">
							...
							<div class="post-title-area">
								...
								<div class="schedule-period-area d-none" {schedule-period-display}="">
									<span class="schedule-period">{start-date-time}</span>
									<span class="schedule-period" {end-date-display}="">{end-date-time}</span>
								</div>
							</div>
							...
							<div class="post-bottom-area">
								<div class="post-bottom-menu">
									<div class="js-emoji-group-layer emoji-area" {emoji-display}="">
										<ul class="emoji-group">{emoji-icons}</ul>
										<span class="emoji-count-area">
											<span class="emoji-count">{emoji-text}</span>
										</span>
									</div>
									<div class="bottom-button-area">
										<button class="js-post-reaction post-bottom-button {reaction-display}">
											<i class="icon-reaction"></i>
											<span>{reaction-text}</span>
										</button>
										<button class="js-post-bookmark post-bottom-button {bookmark-display}">
											<i class="icon-bookmark"></i>
											<span>북마크</span>
										</button>
										<ul class="js-emoji-select-layer emoji-select-group" style="display: none;">
								...
								<div class="cmt-read-wr">
									<div class="comment-count-area">
										<span>댓글</span>
										<span class="comment-count">{remark-count}</span>
									</div>
									<div class="js-read-check-button read-confirmation">
										<span>읽음</span>
										<span class="confirmation-number">{read-count}</span>
									</div>
								</div>
						...
						<div class="post-card-footer js-comment-area">
							...
							<ul class="post-comment-group">{remark-area}</ul>
						</div>
						<div class="js-remark-layer js-edit-layer comment-input-wrap">
							...
							<form class="js-remark-form comment-container on {admin-write-yn}">
								<fieldset>
									<legend class="blind">댓글 입력</legend>
									<div class="js-remark-area js-paste-layer comment-input"
										contenteditable="{remark-contenteditable}" placeholder="{remark-placeholder}">
									</div>
									...
									<label mouseover-text="파일 첨부"
										...
										<i class="icons-link">
											<span class="blind">업로드 버튼</span>
										</i>
									</label>
									<div contenteditable="true" class="js-dimd-layer comment-upload-dimd d-none">
										<span class="dimd-text">첨부할 파일, 이미지 등을 여기에 끌어다 놓으세요</span>
									</div>
								</fieldset>
								<ul class="js-remark-upload-file upload-document-group">{file-area}</ul>
								<ul class="js-remark-upload-img comment-upload-img">{image-area}</ul>
							</form>
						</div>
					</div>
	...
	<div id="detailItemPack" class="d-none">
		<div id="imageComponent" class="d-none">
			<div class="js-post-img document-item image-item" data-code="IMAGE" atch_srno="{ATCH_SRNO}"
				rand_key="{RAND_KEY}" file_idnt_id="{RAND_KEY}" use_intt_id="{USE_INTT_ID}" img_path="{IMG_PATH}"
				atch_url="{ATCH_URL}" file_down_url="{FILE_DOWN_URL}" thum_img_path="{THUM_IMG_PATH}"
				file_nm="{FILE_NM}" file_size="{FILE_SIZE}" rgsr_nm="{RGSR_NM}" rgsn_dttm="{RGSN_DTTM}" cloud_yn="Y"
		...
		<div id="fileComponent" class="d-none">
			<div class="js-post-file document-item file-item" data-code="FILE" atch_srno="{ATCH_SRNO}"
				rand_key="{RAND_KEY}" file_idnt_id="{RAND_KEY}" file_nm="{FILE_NM}" file_size="{FILE_SIZE}"
				rgsr_nm="{RGSR_NM}" rgsn_dttm="{RGSN_DTTM}" use_intt_id="{USE_INTT_ID}" atch_url="{ATCH_URL}"
				img_path="{ATCH_URL}" file_down_url="{FILE_DOWN_URL}" cloud_yn="Y">
				<div class="extension-icon-area"><i class="icon-extension {ext-class}"></i>
					<span class="file-lock" {lock-icon-display}=""><i class="icons-lock"></i></span>
					<!-- 잠금파일일 경우에 block처리 요청 -->
				</div>
				<dl class="document-item-info">
					<dt class="js-file-title"><span class="document-title">{name}</span><em
							class="document-extension">{ext}</em>
					</dt>
					<dd>{size}</dd>
				</dl>
				<button type="button" class="js-down-btn document-download-button" {download-button-display}="">
					<i class="icons-arrow_down"></i>
					<span class="blind">다운로드 버튼</span>
				</button>
				<button type="button" class="js-del-btn delete-button d-none">
					<i class="icons-delete-2"></i>
				</button>
		...
		<div id="mapComponent" class="d-none">
			<div class="js-map-item post-media" data-code="MAP" data-url="{URL}">
				<div class="post-media-icon"><i class="icon-media map"></i></div>
		...
		<div id="bigMapComponent" class="d-none">
			<div class="js-map-item url-preview map map-item" data-url="{URL}" data-code="MAP">
		...
		<div id="linkComponent" class="d-none">
			<a class="js-direct-href post-media" data-preview-url="{url}" data-code="LINK">
				...
				<a class="js-direct-href" data-preview-url="{url}">
					<div class="url-preview">
						...
						<div class="video-wr" {link-video-display}="">
							<iframe {src-video-url}="" frameborder="0" width="603px" height="338px"></iframe>
						</div>
					</div>
				</a>
				<button type="button" class="js-del-btn delete-button d-none">
			...
			<div class="js-task-option">
				<ul class="create-content-group">
					<li class="js-status-layer">
						<div class="create-content-cell title"><i class="icon-post-status"></i></div>
						<div class="create-content-cell">
							<div class="js-task-state state-button-group clearfix {status-code}"
								data-status="{status-code}">
								<button type="button" class="js-stts task-state-button request" stts="request">
									요청
								</button>
								<button type="button" class="js-stts task-state-button progress" stts="progress">
									진행
								</button>
								<button type="button" class="js-stts task-state-button feedback" stts="feedback">
									피드백
								</button>
								<button type="button" class="js-stts task-state-button completion" stts="completion">
									완료
								</button>
								<button type="button" class="js-stts task-state-button hold" stts="hold">
									보류
								</button>
							</div>
						</div>
					</li>
					<li class="js-task-worker-layer js-more-task-li d-none" {data-worker-layer-display}="">
						<div class="create-content-cell title manager"><i class="icon-post-worker"></i></div>
					...
					<li class="js-date-layer js-start-date-layer js-more-task-li d-none" {start-date-text-display}="">
						<div class="create-content-cell title"><i class="icon-post-date"></i></div>
						<div class="js-date-option create-content-cell">
							<div class="js-pickr-layer js-start-flatpickr">
								<label type="button" class="js-date-label add-manager-button"
									...
									<input class="js-pickr-date flatpickr-input ie-pickr" tye="text"
										placeholder="시작일 추가" readonly="readonly" value="{platpickr-start-date}">
								</label>
								<div class="js-date-back-layer date-bg d-none" {start-date-text-display}="">
									<span class="js-pickr-text task-date">
										<span class="js-date-text">{start-date}</span>
									</span>
					...
					<li class="js-date-layer js-end-date-layer js-more-task-li d-none" {end-date-text-display}="">
						<div class="create-content-cell title"><i class="icon-post-date"></i></div>
						<div class="js-date-option create-content-cell">
							<div class="js-pickr-layer js-end-flatpickr">
								<label type="button" class="js-date-label add-manager-button"
									{end-date-button-display}="">
									<input class="js-pickr-date flatpickr flatpickr-input ie-pickr" type="text"
										placeholder="마감일 추가" readonly="readonly" value="{platpickr-end-date}">
								</label>
								<div class="js-date-back-layer date-bg d-none" {end-date-text-display}="">
					...
					<li class="js-priority-layer js-more-task-li" {priority-display}="">
						<div class="create-content-cell title"><i class="icon-post-rank"></i></div>
						<div class="js-priority create-content-cell" data-priority="{priority-code}">
							<button id="priorityButton" type="button"
								class="js-priority-button js-priority-event add-manager-button"
								{priority-button-display}="">
								우선순위 추가</button>
							<div id="prioritySpan" class="js-priority-span js-priority-event rank-item"
								{priority-text-display}="">
								<i class="icons-{priority-gb} small"></i>
								<span class="js-priority-text">{priority-text}</span>
								<button type="button" class="js-remove-priority remove-button"></button>
							</div>
							<div class="js-priority-setting-layer js-priority-event priority-group d-none">
								<button type="button" class="js-priority-setting-button priority-button"
									data-priority-code="low">
									<span> <i class="icons-low"></i> </span>낮음
								</button>
								<button type="button" class="js-priority-setting-button priority-button"
									data-priority-code="normal">
									<span> <i class="icons-normal"></i> </span>보통
								</button>
								<button type="button" class="js-priority-setting-button priority-button"
									data-priority-code="high">
									<span> <i class="icons-high"></i> </span>높음
								</button>
								<button type="button" class="js-priority-setting-button priority-button"
									data-priority-code="argent">
									<span> <i class="icons-argent"></i> </span>긴급
								</button>
							</div>
						</div>
					</li>
					<li class="js-progress-layer js-more-task-li {progress-class}" {progress-display}="">
						<div class="create-content-cell title"><i class="icon-post-progress"></i></div>
						<div class="js-progress create-content-cell">
							<div class="js-progress-bar progress-graph-bar" {progress-width}=""
								data-progress="{progress-code}"></div>
							<div class="progress-graph">{progress}</div>
							<span class="js-progress-text progress-txt">{progress-code} %</span>
						</div>
					</li>
				</ul>
				<button type="button" class="js-more-button add-button" {more-button-display}=""><i
						class="icons-plus-7"></i>항목추가입력</button>
			</div>
		</div>
		<div id="taskWorkerItem">
			<span class="manager-item">
		...
		<div id="foldWrap" class="d-none">
			<button id="postMoreButton" type="button" class="post-more-btn" {more-btn-display}="">더보기</button>
			<div id="summaryFoldArea" class="content-fold" {fold-area-display}="">{fold-area}</div>
		</div>
		<div id="remarkItem" class="d-none">
			<li class="remark-item" remark-srno="{data-remark-srno}" data-user-id="{comment-user-id}">
				...
				<div class="js-remark-view comment-container on {admin-write-yn}">
					<div class="comment-user-area">
						<div class="comment-user">
							<span class="user-name js-comment-user-name">{name}</span>
					...
					<div class="js-remark-layer comment-content modify">
						<form class="js-remark-form comment-text-area">
							<fieldset>
								<legend class="blind">댓글 입력</legend>
								<div class="js-remark-area js-paste-layer comment-input"
									contenteditable="{remark-contenteditable}" placeholder="{remark-placeholder}"></div>
								<div contenteditable="true" class="js-dimd-layer comment-upload-dimd d-none">
									<span class="dimd-text">첨부할 파일, 이미지 등을 여기에 끌어다 놓으세요</span>
								</div>
								<input type="hidden" class="comment-upload-input">
		...
		<div id="todoComponent" class="d-none">
			<div class="todo-progress-area">
				...
				<div class="todo-progress-bar">
					<span {percent-style}=""></span><!-- style="width:20%" -->
				</div>
			</div>
			<ul id="todoUl" class="todo-group">{todo-ul}</ul>
			{todo-rgsr-info}
		</div>
		<div id="todoRgsrComponent" class="d-none">
			<span id="todoRgsrInfo" style="display: none" rgsr-id="{rgsr-id}" self-yn="{self-yn}"
				mngr-wr-yn="{mngr-wr-yn}" mngr-dsnc="{mngr-dsnc}"></span>
		</div>
		<div id="todoMenuComponent" class="d-none">
			<span id="todoDateSpan" class="js-pickr-layer todo-date js-mouseover {dead-line-class}"
				select-date="{select-date}" mouseover-text="{mouseover-date}"
				{tododate-data-display}="">{req-time}</span>
			<span id="participantData" class="js-worker-button js-registration js-mouseover thumbnail size36 radius14"
				data-worker-id="{id}" data-use-intt-id="{use-intt-id}" mouseover-text="{mouseover-worker}" {profile}=""
				{participant-data-display}="">
			</span>
		</div>
		<div id="todoDateComponent" class="d-none">
			<span id="todoDateSpan" class="js-pickr-layer todo-date js-mouseover {dead-line-class}" select-date=""
				mouseover-text="{mouseover-date}"></span>
		</div>
		...
		<div id="todoEditComponent" class="d-none">
			...
			<div class="js-todo-edit-layer subtask-input-area todo-area">
				<input id="todoContent" type="text" class="js-todo-content-input"
					placeholder="할 일 추가 (Enter 또는 Tab) / 최대 60자" autocomplete="off" maxlength="60"
					data-empty-msg="할일 내용을 입력해주세요!" data-required-yn="Y" data-over-msg="할일 내용이 60자가 넘었습니다!">
				<div class="todo-menu">
					<span class="js-pickr-layer js-datepick-button subtask-button">
						<input type="hidden" class="flatpickr flatpickr-input js-pickr-date" readonly="readonly">
						<span class="create-icon-box js-pickr-icon"><i class="icons-calendar"></i></span>
						<span class="js-pickr-text"></span>
					</span>
		...
		<div id="todoItemComponent" class="d-none">
			<li class="todo-item" todo-list-srno="{todo-list-srno}" todo-srno="{todo-srno}">
				<div class="subtask-input-area todo-area {checked}">
					<i class="drag-button" {drag-button-display}=""></i>
					<p class="todo-text"><a href="#" class="icon-checkbox js-todo-checkbox" {icon-checkbox-display}="">
							<i class="icons-check-2"></i>
						</a>
						<span class="js-todo-text-area js-mouseover" mouseover-text="{mouseover-title}"
							{todo-text-display}="">{contents}</span>
						<input class="todoContents js-mouseover js-close-check js-todo-content-input"
							data-gubun="newTodo" placeholder="할일을 입력하세요." value="{contents-value}" type="text"
							autocomplete="off" maxlength="60" data-required-yn="Y" data-empty-msg="할일 내용을 입력해주세요!"
							data-over-msg="할일 내용이 60자가 넘었습니다!" {contents-display}="">
					</p>
					<div class="todo-menu">
						{todo-menu}
					</div>
					<button type="button" class="remove-button" {remove-button-display}=""></button>
				</div>
			</li>
		</div>
				...
				<ul class="create-content-group">
					<li class="schedule-date-li">
						<div id="editDateTimeArea" class="d-none js-schedule-date-layer">
							<div class="create-content-cell title"><i class="icons-calendar"></i></div>
							<div class="create-content-cell">
								<div class="schedule-time">
									<div class="js-pickr-layer js-start-flatpickr">
										<input type="hidden" class="js-pickr-date" id="START_DTTM">
										<input class="js-pickr-text schedule-input" type="text" disabled="disabled">
									</div>
									<div class="js-pickr-layer js-end-flatpickr">
									...
									<div class="oneday">
										<input type="checkbox" id="ondDay" class="d-none">
										<label for="ondDay">종일</label>
									</div>
								</div>
							</div>
						</div>
					...
					<li class="js-attendance-layer">
						<input class="js-attendance-input" data-attendance="{attendance-list}" style="display: none">
						<div class="create-content-cell title manager"><i class="icon-post-worker"></i></div>
						<div class="create-content-cell manager-btn-group">
							...
							<div id="attendanceCount" class="attendee-status" {attendance-count-display}="">
								<span
									class="attendee-status-text participate"><span>참석</span><em>{attendance-count}</em></span>
								<span
									class="attendee-status-text absence"><span>불참</span><em>{nonattendance-count}</em></span>
								<span
									class="attendee-status-text undetermined"><span>미정</span><em>{undefined-count}</em></span>
							</div>
						</div>
					</li>
					<li {place-display}="">
						<div class="create-content-cell title manager"><i class="icon-post-place"></i></div>
						<div class="create-content-cell">
							<input id="placeInput" type="text" class="place-input js-close-check d-none"
								data-required-yn="Y" autocomplete="off" placeholder="장소를 입력하세요">
							<div id="urlPreview" class="url-preview-content schedule">
								<em class="url-preview-title">
									<span class="ellipsis">{place}</span>
									<button type="button" class="js-place-span map-button" data-map-link="{map-link}"
										{map-display}="">지도보기
									</button>
								</em>
							</div>
							<div id="placeSpan" class="js-place-span url-preview map" data-map-link="{map-link}"
								{map-display}="">
								<div>
					...
					<li id="videoLi" {video-display}="">
						<div class="create-content-cell title"><i class="icon-post-video"></i></div>
						<div class="create-content-cell">
							<button id="videoButton" type="button" class="add-manager-button {video-active}">
								화상 회의 추가</button>
							<span id="videoSpan" data-vc-srno="{VC_SRNO}">
								...
								<div id="zoomUrlCopy" class="video-conference-join" tabindex="0">
									<span class="link-copy"><i class="icons-copy"></i></span>
									링크 복사
								</div>
							</span>
						</div>
					...
					<li {alam-display}="">
						<div class="create-content-cell title"><i class="icon-post-alarm"></i></div>
						<div class="create-content-cell">
							<span id="alarmSpan" class="alarm-text">{alarm_time}</span>
							<select id="alarmButton" class="alarm-select d-none"></select>
						</div>
					</li>
					<li {memo-display}="">
						<div class="create-content-cell title manager memo"><i class="icon-post-memo"></i></div>
						<div class="create-content-cell memo">
							<p class="memo-span" id="memoSpan">{memo}</p>
							<div id="memoButton" class="js-upload-area js-paste-layer memo d-none"
								contenteditable="true" data-required-yn="Y" placeholder="메모를 입력하세요."></div>
						</div>
					</li>
				</ul>
			</div>
			<div id="attendanceSelect" class="attendance-button-group" {attendance-select-display}="">
				<button class="attendance-button participate {participate-status}" data-status="participate">참석</button>
				<button class="attendance-button absence {absence-status}" data-status="absence">불참</button>
		...
		<div id="postEditWrap" class="d-none">
			<div class="js-popup-before edit-item create-post-wrap" data-code="{data-code}">
				{post-dimd-layer}
					...
					<div>
						<fieldset>
							...
							<div class="{title-display}">
								<input id="postTitle" type="text" title="제목을 입력하세요." placeholder="제목을 입력하세요."
									autocomplete="off" data-required-yn="Y" class="js-post-title create-title-input"
									maxlength="100" data-empty-msg="제목을 입력하세요!">
							</div>
							<div id="postCntn" class="js-content-area create-content-area {post-code}">
				...
				<div class="create-post-footer clearfix">
					<ul class="js-bottom-ul create-button-group clearfix">
						<li class="js-bottom-item" data-code="upload-file">
							...
							<div class="js-file-menu upload-menu d-none">
								...
								<button class="js-file-option" data-upload="gdrive" {button-upload-google}="">
									<i class="icon-gdrive"></i>구글 드라이브
								</button>
								<button class="js-file-option" data-upload="dropbox" {button-upload-dropbox}="">
									<i class="icon-dropbox"></i>드롭박스
								</button>
								<button class="js-file-option" data-upload="flowdrive" {button-upload-importfile}="">
						...
						<li class="js-bottom-item" data-code="google-place">
							...
							<div class="js-map-menu upload-menu map-search d-none">
								<input type="text" placeholder="장소를 입력하세요" class="js-map-input map-search-input">
							</div>
						</li>
					...
					<div class="create-footer-menu">
						<div class="private-button create-submit-option
						{private-class}" {private-button-display}="">
							{private-text}
						</div>
						<ul class="create-post-option" style="display: none">
							<li>
								<div class="js-private-option option-item full" data-private="full"><i
										class="icons-person-7"></i>전체 공개
								</div>
							</li>
							<li>
								<div class="js-private-option option-item admin" data-private="admin"><i
										class="icons-lock"></i>프로젝트 관리자만
								</div>
							</li>
						</ul>
		...
		<div id="postContents">
			<div class="js-upload-area create-post-content" contenteditable="true" placeholder="ㅣ업무내용을 입력하세요."
	...
	<ul id="workerListItem" class="d-none">
		<li href="#">
			<div class="js-registration all-seach-section-wrap-2" profile-data="{profile-data}"
				data-worker-id="{worker-id}" data-use-intt-id="{use-intt-id}">
				<div class="all-seach-popup-write-1-1"></div>
				<div class="js-worker-profile all-seach-popup-write-2" {profile}="" data-profile="{profile-data}"></div>
	...
	<div id="workersPopup" class="d-none">
		<div class="js-worker-layer all-seach-popup-type-2" tabindex="0">
			<div class="search-work">
				<div class="all-popup-position-fix"><i class="icons-search"></i></div>
				<input id="workerInput" type="text" autocomplete="off">
			</div>
			<div class="js-worker-list all-seach-section-wrap-1 scroll-mask">
				<ul></ul>
			</div>
			<div class="all-seach-popup-button-1 btn-worker"><a href="#">
	...
	<div id="workerSelectCount" class="d-none">
		<div class="js-select-alert all-file-alert-type-2">
			<span class="js-select-count"></span>
			<em class="js-select-cancel"></em>
		</div>
	</div>

	<div id="taskSelectedWorkerItem" class="d-none">
		<span class="js-registration manager-item" data-worker-id="{WORKER_ID}" data-worker-profile="{WORKER_PRFL_PHTG}"
			data-worker-name="{WORKER_NM}">
			<span class="js-worker-profile thumbnail" {profile}=""></span>
			<span class="js-registration-name">{WORKER_NM}</span>
	...
	<div id="projectSelectableLayer" class="d-none">
		<div class="invite-popup-type-4 js-hide-popup-area">
			...
			<div class="search-wr">
				...
				<input type="text" class="js-share-project-srch coperate-input-type-2" placeholder="프로젝트명으로 검색">
			</div>
			...
			<div class="js-project-select menu-text-popup-1" style="display: none">
				<span class="select-count">0</span><span>개 프로젝트가 선택되었습니다.</span>
				<em class="select-clear">선택취소</em>
			</div>
	...
	<div id="reactionCheckPopup" class="d-none">
		<div class="js-reaction-check-layer reaction-check-popup name-type-seach-popup-type-1">
			<div class="name-type-seach-popup-type-1" tabindex="1">
				...
				<div class="js-total-reaction total-reaction">
					<span class="reaction-emoji-item">
						<i class="icon-emoji like"><span class="blind">좋아요</span></i>
						<strong class="js-emoji-count"></strong>
					</span>
					<span class="reaction-emoji-item">
						<i class="icon-emoji please"><span class="blind">부탁해요</span></i>
						<strong class="js-emoji-count"></strong>
					</span>
					<span class="reaction-emoji-item">
						<i class="icon-emoji sad"><span class="blind">힘들어요</span></i>
						<strong class="js-emoji-count"></strong>
					</span>
					<span class="reaction-emoji-item">
						<i class="icon-emoji great"><span class="blind">훌륭해요</span></i>
						<strong class="js-emoji-count"></strong>
					</span>
					<span class="reaction-emoji-item">
						<i class="icon-emoji thank"><span class="blind">훌륭해요</span></i>
						<strong class="js-emoji-count"></strong>
					</span>
					<div class="total-emoji">
						<em>총</em>
						<strong class="js-total-emoji-count"></strong>
					</div>
				</div>
	...
	<div id="reactionCheckItem" class="d-none">
		<li class="js-reaction-check-item" data-user-id="{RCVR_USER_ID}">
			<div class="post-author">
				...
				<dl class="post-author-info">
					<dt>
						<strong class="author ellipsis">{RCVR_USER_NM}</strong>
						<em class="position ellipsis">{JBCL_NM}</em>
					</dt>
					<dd>
						<strong class="company ellipsis">{RCVR_CORP_NM}</strong>
						<span class="team ellipsis">{RCVR_DVSN_NM}</span>
					</dd>
				</dl>
			</div>
		</li>
	...
	<div id="readCheckPopup" class="d-none">
		<div class="js-read-check-layer read-confirmation name-type-seach-popup-type-1" tabindex="1">
			<div class="name-type-seach-popup-header-type-1">
				<span>읽음확인</span>
				<button class="btn-close js-close-event">
					<i class="icons-close-1"></i>
			...
			<div class="project-search">
				<i class="icons-search"></i>
				<input type="text" placeholder="참여자명으로 검색" autocomplete="off" class="project-search-input">
			</div>
			<div class="js-read-tab team-wrap-invite-type-1">
				<a href="#">
					<div data-code="READ" class="js-read-tab-item team-job-invite-type-2 btn">읽음</div>
				</a>
				<a href="#">
					<div data-code="UNREAD" class="js-read-tab-item team-job-invite-type-1 btn">미확인</div>
				</a>
			</div>
	...
	<div id="readCheckItem" class="d-none">
		<li class="reader-item" data-user-id="{RCVR_USER_ID}">
			<div class="post-author"><span class="thumbnail size40 radius16" {profile-url}=""></span>
				<dl class="post-author-info">
					<dt>
						<strong class="author ellipsis">{RCVR_USER_NM}</strong>
						<em class="position ellipsis">{JBCL_NM}</em>
				...
				<div class="read-section"><strong id="readText">{read-text}</strong>
					<p>{read-time}</p>
				</div>
			</div>
		</li>
			...
			<div class="js-subtask-area subtask-wrap">
				<div class="subtask-header">
					<span class="subtask-title"> <i class="icons-subtask"></i>하위업무<em
							class="js-subtask-count subtask-count">{subtask_count}</em> </span>
				</div>
				<ul class="js-subtask-ul subtask-list ui-sortable" style="display: block"
					data-project-srno="{COLABO_SRNO}" data-post-srno="{COLABO_COMMT_SRNO}">
					{SUBTASK_LIST}
				</ul>
				...
				<button type="button" class="js-add-subtask-button add-button"><i class="icons-plus-7"></i>하위업무
					추가</button>
			</div>
		</div>
	</div>
	<div id="subTaskItem" class="d-none">
		<li id="subtask-{COLABO_COMMT_SRNO}" class="js-subtask-li {status-class}" index="{index}"
			task-srno="{TASK_SRNO}" data-project-srno="{COLABO_SRNO}" data-post-srno="{COLABO_COMMT_SRNO}"
			data-del-yn="{del-yn}">
			<div class="subtask-input-area">
				<i class="drag-button">
					<span class="blind">Move</span>
				</i>
				<div class="js-subtask-status-layer js-subtask-layer subtask-status-area">
					...
					<ul class="js-status-setting-layer subtask-status-list" style="display: none">
						<li>
							<div class="js-status-setting-button subtask-status request" data_status_code="0">
								요청</div>
						</li>
						<li>
							<div class="js-status-setting-button subtask-status progress" data_status_code="1">
								진행</div>
						</li>
						<li>
							<div class="js-status-setting-button subtask-status feedback" data_status_code="4">
								피드백</div>
						</li>
						<li>
							<div class="js-status-setting-button subtask-status completion" data_status_code="2">
								완료</div>
						</li>
						<li>
							<div class="js-status-setting-button subtask-status hold" data_status_code="3">
								보류</div>
						</li>
					</ul>
				</div>
				<div class="subtask-input">
					...
					<input class="subtask-title js-subtask-input js-mouseover" tab-code="input" maxlength="50"
						data-empty-msg="하위 업무 제목을 입력하세요!" data-required-yn="Y" value="{TASK_NM}" {readonly_yn}="">
					<span class="subtask-comment" {remark_display}=""><i class="icons-comment2"></i><span
							class="js-subtask-remark-count">{REMARK_CNT}</span></span>
				</div>
				<ul class="js-subtask-menu subtask-menu">
					<li class="js-subtask-date-layer subtask-menu-date js-date-tooltip {mouseover-class}"
						tab-code="date" mouseover-text="{mouseover-date}" data_start_dt="{START_DT}"
						data_end_dt="{END_DT}">
						<div class="js-pickr-layer">
							<input type="hidden" class="js-subtask-date-input" readonly="readonly">
							<div class="subtask-date-input-div">
								...
								<span class="js-subtask-date-text js-flatpicker subtask-date d-none {dead-line-class}"
									{date_text_display}="">{end_dt_text}</span>
							</div>
						</div>
					</li>
					<li class="js-subtask-priority-layer js-subtask-layer subtask-menu-priority js-mouseover"
						tab-code="priority" mouseover-text="{mouseover-priority}" data_priority="{PRIORITY}">
						<button type="button"
							class="js-priority-level icon-subtask-level js-priority-button {priority_code}"
							{priority_icon_display}=""><em class="blind"></em></button>
						<button type="button"
					...
					<li class="subtask-menu-worker js-subtask-worker-layer js-mouseover" tab-code="worker"
						data_worker_id_list="{worker_id_list}" data_worker_name_list="{worker_name_list}"
						data_worker_profile_list="{data_worker_profile_list}" mouseover-text="{mouseover-worker}">
						<button type="button"
							...
							<span>
								<i class="icons-person-6 small"></i>
							</span>
						</button>
						<button type="button"
							...
							<span class="subtask-manager-area">
								<span class="js-thumb-image thumbnail" {thumbnail_image}=""></span>
								<span class="subtask-manager-number d-none"
									{worker_count_display}="">{worker_count}</span>
							</span>
						</button>
					</li>
				</ul>
				...
				<button type="button" class="js-subtask-remove remove-button" {remove_display}="">
					<span class="blind">삭제</span>
				</button>
				<div class="js-priority-setting-layer priority-group d-none">
					<button type="button" class="js-priority-setting-button js-subtask-priority priority-button"
						data-key-index="0" data_priority_code="">
						<span> <i class="icons-delete small lv0"></i> </span>취소
					</button>
					<button type="button" class="js-priority-setting-button js-subtask-priority priority-button"
						data-key-index="1" data_priority_code="0">
						<span> <i class="icons-low small lv1"></i> </span>낮음
					</button>
					<button type="button" class="js-priority-setting-button js-subtask-priority priority-button"
						data-key-index="2" data_priority_code="1">
						<span> <i class="icons-normal small lv2"></i> </span>보통
					</button>
					<button type="button" class="js-priority-setting-button js-subtask-priority priority-button"
						data-key-index="3" data_priority_code="2">
						<span> <i class="icons-high small lv3"></i> </span>높음
					</button>
					<button type="button" class="js-priority-setting-button js-subtask-priority priority-button"
						data-key-index="4" data_priority_code="3">
						<span> <i class="icons-argent small lv4"></i> </span>긴급
					</button>
				</div>
			</div>
		</li>
	...
	<div id="subtaskInputItem" class="d-none">
		<div class="subtask-registered-area js-subtask-edit-area">
			<div class="subtask-input-area js-subtask-li">
				<div class="js-subtask-status-layer js-subtask-layer subtask-status-area">
					<button type="button" class="js-subtask-status-button subtask-button subtask-status request"
						data_status="0">
						요청
					</button>
				...
				<input type="text" class="subtask-input js-subtask-input" tab-code="input" maxlength="50"
					data-empty-msg="하위 업무 제목을 입력하세요!" data-required-yn="Y" placeholder="업무명 입력 (Enter로 업무 연속 등록 가능)">
				<ul class="js-subtask-menu subtask-menu">
					...
					<li class="js-subtask-priority-layer js-subtask-layer subtask-menu-priority js-mouseover clearfix"
						data_priority="" mouseover-text="우선 순위 추가">
						<button type="button" class="js-priority-level icon-subtask-level js-priority-button d-none"><em
								class="blind"></em></button>
						<button type="button"
					...
					<li class="subtask-menu-worker js-subtask-worker-layer js-mouseover" data_worker_id_list=""
						data_worker_name_list="" data_worker_profile_list="" mouseover-text="담당자 추가">
						<button type="button"
						...
						<button type="button"
							...
							tab-code="worker">
							<span class="subtask-manager-area">
								<span class="js-thumb-image thumbnail"></span>
								<span class="subtask-manager-number d-none">{worker_count}</span>
							</span>
						</button>
					</li>
				</ul>
				...
				<div class="js-priority-setting-layer priority-group d-none">
					<button type="button" class="js-priority-setting-button js-subtask-priority priority-button"
						data-key-index="0" data_priority_code="">
						<span> <i class="icons-delete lv0"></i> </span>취소
					</button>
					<button type="button" class="js-priority-setting-button js-subtask-priority priority-button"
						data-key-index="1" data_priority_code="0">
						<span> <i class="icons-low lv1"></i> </span>낮음
					</button>
					<button type="button" class="js-priority-setting-button js-subtask-priority priority-button"
						data-key-index="2" data_priority_code="1">
						<span> <i class="icons-normal lv2"></i> </span>보통
					</button>
					<button type="button" class="js-priority-setting-button js-subtask-priority priority-button"
						data-key-index="3" data_priority_code="2">
						<span> <i class="icons-high lv3"></i> </span>높음
					</button>
					<button type="button" class="js-priority-setting-button js-subtask-priority priority-button"
						data-key-index="4" data_priority_code="3">
						<span> <i class="icons-argent lv4"></i> </span>긴급
					</button>
				</div>
			</div>
			<p class="subtask-close-text subtask-reset-text" style="display: block">
				취소하려면 Esc 키를 누르세요.
			</p>
		</div>
	</div>
	...
	<div id="selectableProjectItem" class="d-none">
		<li class="project-item ui-state-default {check_yn}" colabo-srno="{COLABO_SRNO}">
			<a href="#">
				<button class="edit-check check-menu-item flow-content-chk {check_yn}"></button>
				<div class="color-code flow-content-list flow-content-po-t color-code-{BG_COLOR_CD}"
					data-color="{BG_COLOR_CD}"></div>
				<span class="project-ttl share-project-ttl">{TTL}</span>
			</a>
		</li>
	</div>
		...
		<div class="flow-project-make-1">
			<div class="flow-project-make-2">
				<div class="project-invite-popup-1">
					<div class="name-type-seach-popup-header-type-1">
						<span>참여 요청</span>
						<a href="#" id="closeBtn" class="btn-close"><i class="icons-close-1"></i></a>
					</div>
					<div class="sub-drag-picture-section-1">
	...
	<div id="joinParticipantItem" class="d-none">
		<li class="project-invite-popup-list-1 js-join-participant-item" data-user-id="{user-id}">
			<div class="mini-mode-text-sub-area-1">
				<div class="js-profile-image mini-mode-main-picture-1" {profile-image}=""></div>
				<div class="mini-mode-area-list-type-1">
	...
	<div id="memberItem" style="display:none">
		<li class="js-participant-item" data-id="{rcvr-cd}" rcvr_cd="{rcvr-cd}" rcvr_gb="{rcvr-gb}" id="{id}"
			sendience_gb="{sendience-gb}" profile-image="{profile-image}">
			<div class="post-author">
				<span class="js-profile thumbnail size40 radius16" {profile}=""></span>
				<dl class="post-author-info">
					<dt>
						<strong id="name" class="author">{name}</strong>
						<em>{position}</em>
					</dt>
					<dd {personal-yn}="">
						<strong class="company">{company}</strong>
			...
			<button type="button" class="js-participant-chat participant-chat-button d-none">
				<i class="icons-chat"><span class="blind">채팅</span></i>
			</button>
			<a id="plusBtn" href="#" class="project-invite-plus-1 d-none">
	...
	<script src="/flow-renewal/dist/js/common.min.js?5.1.696.10668"></script>
	...
	<script>
		...
		function local2session() {
			if (location.pathname !== "/main.act" && location.pathname !== "/miniMain.act") return;
	...
	<script defer="" src="/flow-renewal/dist/js/main.min.js?5.1.696.10668"></script>
	...
	<div id="popupDraw" class="d-none">
		...
		<div id="colorPopup">
			<div class="color-popup flow-project-popup-3 d-none">
				<div class="flow-project-header-1">프로젝트 색상
				...
				<div class="flow-content">
					<div class="flow-category-option-3">
						<ul id="selectColorTypes" class="select-color-group">
							<li class="color-item project-color-type-5" color-code="5"><a href="#"><em></em></a></li>
							<li class="color-item project-color-type-11" color-code="11"><a href="#"><em></em></a></li>
							<li class="color-item project-color-type-1" color-code="1"><a href="#"><em></em></a></li>
							<li class="color-item project-color-type-10" color-code="10"><a href="#"><em></em></a></li>
							<li class="color-item project-color-type-2" color-code="2"><a href="#"><em></em></a></li>
							<li class="color-item project-color-type-7" color-code="7"><a href="#"><em></em></a></li>
							<li class="color-item project-color-type-9" color-code="9"><a href="#"><em></em></a></li>
							<li class="color-item project-color-type-6" color-code="6"><a href="#"><em></em></a></li>
							<li class="color-item project-color-type-3" color-code="3"><a href="#"><em></em></a></li>
							<li class="color-item project-color-type-4" color-code="4"><a href="#"><em></em></a></li>
							<li class="color-item project-color-type-8" color-code="8"><a href="#"><em></em></a></li>
							<li class="color-item project-color-type-0" color-code="0"><a href="#"><em></em></a></li>
						</ul>
					</div>
		...
		<div id="confirmPopup">
			<div class="input-popup flow-project-popup-4 d-none">
				<div class="flow-project-header-1"><span class="popup-title"></span>
					<a href="#" class="close-event flow-close-type-1"></a>
				</div>
				<div class="flow-content">
					<div class="flow-content-input-1">
						<input class="popup-input" type="text" placeholder="" maxlength="50" data-required-yn="Y"
							data-empty-msg="라벨 이름을 입력하세요." data-over-msg="라벨 이름은 50자 이하로 입력해주세요.">
					</div>
					<div class="flow-pop-button-type-1">
						<a href="#">
		...
		<div id="blockPopup">
			<div class="limit-popup d-none">
				...
				<button id="detailLinkBtn" class="btn-detail-link d-none">자세히 알아보기</button>
				<a class="limit-link-button submit-event"></a>
				<button type="button" class="limit-close-button close-event">
					<span class="blind">닫기</span>
				</button>
		...
		<div>
			<div class="limit-popup chat-limit-popup collect">
				<dl class="limit-content">
					...
					<dd>
						서비스 업그레이드를 통해<br>
						자유롭게 모아보기 기능을 이용해 보세요!
					</dd>
				</dl>
				<a href="/" class="limit-link-button">서비스 업그레이드 <span class="d-none">버전이 되어야 하는거 아닌지?</span></a>
		...
		<div id="miniAlertPopup">
			<div class="mini-confirm-popup flow-project-popup-3 popup-quit d-none">
		...
		<div id="labelWrap" class="d-none">
			<div class="label-popup allProjLabel-popup flow-project-popup-8" style="display: none">
				<div class="flow-project-header-1">
		...
		<div id="pushWrap" class="d-none">
			<div class="push-alarm-popup allProjPushAlarm-popup flow-project-popup" style="display:none">
				<div class="flow-project-header-1">
					알림 설정
					<button class="js-service-helper js-mouseover" service-code="NOTIFICATION"> <i
							class="icons-help"></i></button>
					<a href="#" class="close-event flow-close-type-1"></a>
				</div>
		...
		<div id="profilePopup">
			...
			<div class="name-card">
				<i class="profile-image js-profile-image {IMG_DEFAULT}" {profile_image}=""></i>
				<!--프로필 사진 미설정 시 .default 클스 추가-->
				<div class="info">
					<p class="info-box">
						<span class="name ellipsis">{USER_NAME}</span>
						<span class="position">{USER_POSITION}</span>
					</p>
					<p class="info-box">
						<span class="company">{USER_COMPANY}</span>
						<span class="department">{USER_DEPARTMENT}</span>
					</p>
				</div>
			</div>
			<div class="contact-section scroll-mask">
				<ul class="contact-contents">
					<li class="status js-user-status" {user_status_display}="">
						<i class="icon-status"></i>
						상태 설정
					</li>
					<li>
					...
					<li>
						<em><i class="profile-tell js-user-call"></i></em>
						<span>{USER_CALL}</span>
					</li>
					<li id="userTxt" class="txt" {li_slogan_display}="">
			...
			<div class="btn-wr">
				...
				<button class="btn-video js-btn-video" {btn_video_display}="" user_id="{USER_ID}">
					화상 회의
					<i></i>
				</button>
			</div>
			...
			<div class="check-box-popup popup-setting-wr d-none">
				...
				<div class="flow-project-popup-5 mini">
					...
					<div class="flow-content">
						...
						<div class="check-box">
							<input class="js-checkbox-input" type="checkbox">
							<label class="js-checkbox-label"></label>
							<label class="popup-cont js-checkbox-label cursor-pointer"></label>
						</div>
		...
		<div id="emailAuthLayer" class="d-none">
			<div class="auth-popup js-certification-popup flow-login-popup flow-project-popup-6 d-none">
				<div class="flow-project-header-1">
					<dt class="popup-title"></dt>
					<button class="btn-close close-event">
						<i class="icons-close-1"></i>
				...
				<div class="flow-content">
					<div class="login-number-wrap">
						<p class="login-number"><span id="authEmail" class="popup-cont">{contents}</span> 으로</p>
						<p class="login-number">6자리 인증번호가 전송되었습니다.</p>
					</div>
					<div class="login-input-wrap">
						<input id="authInput" type="text" placeholder="인증번호 입력" class="login-popup-input" maxlength="6">
						<div class="login-text-count js-auth-counter"></div>
					</div>
					<div class="auth-error-text">
						<span id="unValidAuth" style="display : none">인증번호가 일치하지 않습니다.</span>
						<span id="timeoutAuth" style="display : none">인증시간이 만료되었습니다.</span>
						<span id="resendAuth" class="resend-txt" style="display : none; cursor : pointer;">재전송</span>
						<span id="noneNumericAuth" style="display : none">숫자만 입력해주세요</span>
					</div>
					<a href="#">
						<div class="confirm-button login-popup-button submit-event">확인</div>
					</a>
				</div>
			</div>
		</div>
	...
	<div id="itemComponent" class="d-none">
		<div class="js-file-SearchFilter">
			...
			<ul id="periodLi">
				<li>
					<input id="{uuid}" type="radio" name="period-type" class="radio-input {select_class}"
						data-code="{key}" {checked}="">
					<label for="{uuid}" class="js-period-type radio-label-checkbox"
						data-code="{key}">{value}</label>{select_div}
				</li>
			</ul>
			<ul id="tmplLi">
				<li>
					<input id="{uuid2}" type="radio" name="tmpl-type" class="radio-input" data-code="{key}"
						{checked}="">
					<label for="{uuid2}" class="js-tmpl-type radio-label-checkbox" data-code="{key}">{value}</label>
				</li>
			</ul>
			<ul id="fileLi">
				<li>
					<input id="{uuid3}" type="radio" name="file-type" class="radio-input" data-code="{key}"
						{checked}="">
					<label for="{uuid3}" class="js-file-type radio-label-checkbox" data-code="{key}"><i
							class="icon-file-type {keyClass}"></i>{value}</label>
				</li>
			</ul>
		</div>
		<div class="js-file-Alarm">
			<div id="pushSettingContentsDiv">
				<div id="pushSettingContents">
					<dl class="js-push-wrap alarm-popup-set push" data-push-alarm="{PUSH_ALAM_YN}">
						<dt>
						...
						<dd class="js-push-area">
							...
							<div data-push="{PUSH_COMMT_ALAM_YN}" class="js-push-commt js-push-selected">
								{PUSH_COMMT_ALAM_TEXT}
							</div>
						...
						<dd class="js-push-area">
							...
							<div data-push="{PUSH_REMARK_ALAM_YN}" class="js-push-remark js-push-selected">
								{PUSH_REMARK_ALAM_TEXT}
							</div>
					...
					<dl class="js-alarm-wrap alarm-popup-set alarm" data-alarm-list="{ALAM_LIST}">
						<dt>
							<span class="set-title alarm">알림 리스트 설정</span>
						</dt>
						<dd class="js-alarm-item cursor-pointer">
							<span>모두받기</span>
							<input type="radio" name="alarm" id="allAlarm" class="js-radio-input radio-input">
							<label for="allAlarm" class="radio-label js-alarm-label js-allAlarm"></label>
						</dd>
						<dd class="js-alarm-item cursor-pointer">
							<span>나와 관련된 알림만 받기</span>
							<input type="radio" name="alarm" id="relatedAlarm" class="js-radio-input radio-input">
							<label for="relatedAlarm" class="radio-label js-alarm-label js-relatedAlarm"></label>
						</dd>
					</dl>
				</div>
			</div>
		...
		<div class="js-file-ItemSchedule">
			<ul id="participantItemLi">
				<li class="js-participant-item" id="participant-item">
					<div id="{id}" class="confirmation-item js-user-id">
						<div class="js-participant-profile participant-thumbnail attendee {gubun}" {profile}=""></div>
						<dl class="participant-info">
							<dt class="participant-name">{name}<em class="participant-position">{position}</em></dt>
							<dd class="participant-detail-info">
								<strong class="participant-company">{company}</strong>
								<span class="participant-affiliation">{affiliation}</span>
							</dd>
						</dl>
						<div class="badge-area"><span class="badge {gubun}" {badge-display}="">{badge}</span></div>
					</div>
				</li>
			</ul>
			<div id="confirmationPopupDiv">
				<div id="confirmationPopup" class="flow-all-background-1">
					<div class="flow-project-make-1">
						<div class="flow-project-make-2">
							<div id="confirmationInnerPopup" class="js-attendance-popup search-confirmation-popup">
								<div class="confirmation-header-top">
									<h4 class="confirmation-title">참석자 확인</h4>
									<button id="confirmationPopupCloseBtn" type="button" class="btn-close">
								...
								<div class="confirmation-header-bottom">
									<div class="project-search">
										<i class="icons-search"></i>
										<input type="text" id="confirmationPopupSearchText"
			...
			<div id="attendanceViewItem">
				<span class="js-registration participant-thumbnail attendee {attendance-status} js-mouseover"
					{profile}="" data-worker-id="{id}" data-registration-name="{name}" mouseover-text="{name}"></span>
			</div>
			<div id="attendanceEditItem">
				<span class="js-registration manager-item" data-worker-id="{id}">
					<span class="js-worker-profile thumbnail" {profile}=""></span>
					<span class="js-registration-name">{name}</span>
					<button type="button" class="js-remove-worker remove-button"></button>
				</span>
			</div>
			<div id="attendanceMoreItem">
				<span class="js-more-registration-button js-registration participant-thumbnail more"></span>
			</div>
		</div>
		<div class="js-file-Upload">
			...
			<ul id="fileErrorLi">
				<li><span class="file_name">파일명</span><em>.pdf</em><span class="fail_info">오류</span></li>
			</ul>
		</div>
		<div class="js-file-Mention">
			<div id="mentionLayer">
				<div class="js-mention-layer all-seach-popup-type-2 inner-popup d-none">
		...
		<div class="js-file-PostPopup">
			<div id="uploadDiv">
				...
				<div class="js-upload-area js-paste-layer create-post-content" contenteditable="true"
					placeholder="ㅣ업무내용을 입력하세요." spellcheck="false"></div>
			</div>
		</div>
					...
					<div class="flow-project-make-1 back-area">
						<div class="flow-project-make-2 back-area">
							<div class="flow-project-popup-9 contents-area">
								<div class="flow-project-header-1">
									<span>초대장 확인</span>
									<button class="btn-close"><i class="icons-close-1"></i></button>
								</div>
								<div class="invite-popup-wrap-1">
									<div class="js-prfl invite-flow-picture-1"></div>
									<div class="invite-flow-text-type-wrap-1">
										<span class="js-title invite-flow-text-type-2"></span>
										<em class="js-name invite-flow-text-type-3"></em><span
											class="invite-flow-text-type-4">님이 프로젝트에 초대합니다.</span>
										<span class="js-count invite-flow-text-type-5"></span>
									</div>
								</div>
								<div class="flow-pop-button-type-1">
									<a href="#">
	...
	<script async="" src="/flow-renewal/js/main.js?5.1.696.10668"></script>
