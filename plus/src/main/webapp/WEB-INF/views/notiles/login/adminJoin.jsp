...
<body>
	...
	<div class="business-signup-layer">
		...
		<div class="pc-login-wrap" id="busi" style="top: 0px; left: 0px; z-index: 3000;">
			...
			<div class="fl-header-wrap">
				...
				<div class="fl-header">
					...
					<h1>
						<a href="/"><img id="headerLogoImg" src="design2/img_login/bi_flow.png" style="cursor: pointer;"
								alt="flow"></a>
					</h1>
			...
			<div class="f-login-wrap mCustomScrollbar"
				...
				<form id="frm" name="frm" action="">
					<fieldset style="padding-bottom: 30px;">
						...
						<div class="fl-content" id="businessCreateAccount" style="padding-top: 50px;">
							...
							<div class="input-box-style">
								...
								<div class="blocklabel">
									...
									<div class="inputbox ok">
										...
										<input type="text" id="email" name="email" maxlength="50" tabindex="1"
											placeholder="example@gmail.com" value="" />

										<button type="button" class="btn-ok-text" data-langcode="H359">확인</button>
										<button type="button" class="btn-clear-text" style="cursor: pointer;"
											data-langcode="H381">삭제</button>
										<!-- 메시지 -->
										<div class="error-msg">
								...
								<div class="blocklabel">
									...
									<div class="inputbox ok">
										...
										<input type="text" name="name" id="name" tabindex="2" maxlength="50"
								...
								<div class="blocklabel">
									...
									<div class="inputbox ok">
										...
										<input type="password" name="pwd" id="pwd" class="password-input" maxlength="50"
											tabindex="3" placeholder="비밀번호 입력" value="" data-langcode="H399">
								...
								<div class="blocklabel">
									...
									<div class="inputbox ok">
										...
										<input type="password" name="pwdCheck" id="pwdCheck" class="password-input"
											maxlength="50" tabindex="4" placeholder="비밀번호 재입력" data-langcode="H477">
								...
								<div class="blocklabel">
									...
									<div class="inputbox ok">
										<input type="text" id="coName" name="coName" tabindex="11" maxlength="50"
								...
								<div class="blocklabel url-box">
									...
									<div class="inputbox ok" style="width: 290px">
										...
										<input type="text" id="coUrl" name="coUrl" tabindex="12" maxlength="50"
											readonly="readonly" placeholder="${newUrl}" value="${newUrl}"
							...
							<div class="btn-box">
								<button type="button" id="nextToSettingTeam" class="btn-bigs c-blue"
									data-langcode="H482">회원가입</button>
							</div>
						</div>
		...
		<!-- 인증번호 확인 -->
		<div id="checkJoinPopup" class="flow-all-background-1 d-none" style="z-index: 3000">
			<div class="flow-project-make-1">
				<div class="flow-project-make-2">
					<div id="popupLayer" class="flow-login-popup"
						style="height: 180px; felx-wrap: wrap; align-center: space-around">
	...
	<script>
		$("#nextToSettingTeam").on("click",function (e) {
					if ($('#pwd').val() != $('#pwdCheck').val()) {
						$('#toastWrap').find('.alert-type').find('div').text("비밀번호를 바르게 입력하세요");
						$('#toastWrap').fadeIn(1500);
						$('#toastWrap').fadeOut(1500);
					} else {
						...
						$.ajax({
							...
							/* dataType : "json", */
								$('#toastWrap').find('.alert-type').find('div').text( email + "로 인증메일이 발송되었습니다");
								$('#toastWrap').fadeIn(1500);
								$('#toastWrap').fadeOut(1500);
								...
								$("#joinNum").on("change keyup paste",function () {
									if ($("#joinNum").val() == key) {
										...
										$("join").on("click",function () {
												$('#toastWrap').find('.alert-type').find('div').text("인증번호를 확인하세요");
												$('#toastWrap').fadeIn(1500);
												$('#toastWrap').fadeOut(1500);
											});
										}
