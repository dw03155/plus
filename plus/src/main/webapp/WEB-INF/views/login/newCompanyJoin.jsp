...
<body>
	<div id="companyJoinLayer" class="">
		...
		<div id="companyJoinMain" class="login-wrap invite-login">
			<div class="login-text">새로운 회사 참여</div>
				...
				<div class="flow-project-make-2">
					<div id="popupLayer" class="flow-login-popup popup-10">
						...
						<div id="coInfo" class="flow-content">
							...
							<button id="joinSubmit1" class="btn-popup01">닫기</button>
							<button id="joinSubmit2" class="btn-popup01">회사정보입력</button>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- 기존회사가입하기 -->
		<div id="JoinPopup" class="flow-all-background-1 d-none">
			<div class="flow-project-make-1">
				<div class="flow-project-make-2">
					<div id="popupLayer" class="flow-login-popup popup-10">
						<div class="flow-project-header-1">
							가입정보를 입력하세요! <a id="closePopupBtn"
								class="flow-close-type-1"></a>
						</div>
						<div id="joinInfo" class="flow-content">
							<ul class="content-company">
								<li id="email" class="email">
								이메일
									<input type="text" id="email" name="email">
								</li>
								<li id="name" class="memName">
								이름
								...
								<li id="pwdCheck" class="pwdCheck">
								비밀번호 확인
									<input type="password" id="pwdCheck" name="pwdCheck">
								</li>	
							</ul>
							<input type="hidden" id="coName" name="coName">
							<input type="hidden" id="coUrl" name="coUrl">
							<button id="joinBtn" name="joinBtn" class="btn-popup01">회원가입</button>
						</div>
					</div>
				</div>
			</div>
	...
	<script>
		...
		$('#joinSubmit2').on('click',function(){
			location.href = '/insertMember1.do';
		});
