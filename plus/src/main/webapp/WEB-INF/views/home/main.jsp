...
<script>
	var _ENTER_YN = "N";
	var _GUBUN = "WEB";
	var _SUB_PATH_BY_TINY_URL = ""
	if ("WEB" !== _GUBUN)
		MobileApp.goPostByTinyUrl(_SUB_PATH_BY_TINY_URL);
</script>

<link rel="stylesheet"
	href="/flow-renewal/assets/css/reset.css">
<link rel="stylesheet"
	href="/flow-renewal/dist/css/common.min.css">
...
<div id="allUpgradeStep"></div>
	...
	<div id="paymentLayer" class="d-none">
		<div class="upgrade-top-banner-1 position-relative">
			<div class="top-banner-type-1 width-100p-fix">
				<div class="top-banner-sub-type-1">
					<span>계좌이체 또는 자동이체를 통해서도 결제할 수 있습니다.</span> <a href="#"
						id="autoAccountBtn"><em>신청하기</em></a>
				</div>
			</div>
		</div>
		...
		<div class="upgrade-singup-header">
			...
			</a> <a id="closePayment" href="#" class="login-close-button"></a>
		</div>
							...
							<div class="payment-left">
								...
								<ul id="payInfoUl" class="payment-info">
									<li><label class="payment-info-title">이름</label> <input
										id="userName" maxlength="30" class="payment-input" type="text"
									...
									<li id="cardLi"><label class="payment-info-title">카드번호</label>
										...
										class="payment-input input-type2 js-number-input"
										type="password" maxlength="4" /> <input id="cardNum4"
										class="payment-input input-type2 js-number-input"
									...
									<li><label class="payment-info-title">비밀번호 앞 두자리</label> <input
										id="cardPassword"
										class="payment-input input-type2 js-number-input" type="text"
										autocomplete="off" maxlength="2" /> <span
									...
									<li><label class="payment-info-title">사업자번호 10자리
										...
										autocomplete="off" placeholder="- 빼고 입력" maxlength="10" />
								...
								<div class="payment-amount-wrap">
									...
									<div class="payment-amount-content">
														...
														<div>
															...
															<p class="tooltip-square">
																...
																있습니다.<br /> <em>10명까지 월 <em id="monthPriceMain">60,000</em>원
																	적용,
																</em><br /> <em>10명 초과 시, 인원 당 월 <em id="monthPriceSub">6,000</em>원
																	적용됩니다.
																</em>
															</p>
														</div>
										...
										<input type="checkbox" id="paymentAgree"
											class="payment-agree-input" /> <label class="payment-agree"
											for="paymentAgree"> <span class="payment-agree-text"><a
												id="termsOfServiceBtn" href="#">정기과금 이용약관</a> 내용을 확인하였고, 이에
												동의합니다.</span>
										</label>
										<p class="error-text d-none">정기과금 이용약관에 동의해 주세요.</p>
										<button type="button" class="payment-button"
											id="submitPayment">정기결제 신청</button>
									</div>
								</div>
							</div>
						</fieldset>
			...
			<div class="js-tearm-of-service-item">
				<div class="agreement-section">
					...
					<ul class="agreement-contents">
						...
						<li>・ 이미 지불이 완료된 금액에 대해서는 환불이 불가합니다. 단, 플로우의 귀책 사유로 인해 잘못된
							금액이 결제되었거나 초과 과금이 발생한 경우 환불이 가능합니다.</li>
					</ul>
					...
					<ul class="agreement-contents">
						<li>・ 연간 사용금액에 대해서 선결제가 진행됩니다. 기본요금 이외에 등록된 사용인원을 기준으로 추가요금이
							산정됩니다. 만일 연간 과금 결제 이후 추가인원이 늘어날 경우 추가된 인원에 대해서도 과금이 청구됩니다. 연간
							과금에서 월간 과금으로 전환을 지원하지 않습니다.</li>
						<li>・ 연간 과금으로 결제 시, 계약 기간 중 서비스 탈퇴 시 위약금이 발생합니다. 위약금은 "월간과금
							대비 할인받은 금액 + 남은 기간 동안 지불할 금액의 10%"이며, 위약금에는 Tax가 부과되지 않습니다.</li>
						<li>・ 월간과금 대비 할인받은 금액은 연간과금 계약시 체결한 월 청구금액 기준으로 계산되며, 남은 기간
							동안 지불할 금액의 10%는 서비스 탈퇴 신청일부터 이전 30일동안 최대 사용인원 기준으로 계산됩니다. <br>
							위약금 계산 공식은 아래와 같습니다. <br> (1) 월간과금 요금제 대비 할인받은 금액 = {사용기간 월
							X (월간과금제월요금 - 연간과금제월요금)}<br> (2) 남은 기간 동안 지불할 금액의 10% =
							{연간과금제 월계약금액 X (총계약기간 월-사용기간 월)+(추가사용인원 사용금액)} X 10%<br> (3)
							위약금 = (1) + (2)
						</li>
					</ul>
					...
					<br> <strong>기타</strong>
					<ul class="agreement-contents">
						<li>・ 플로우가 지정한 결제 대행업체는 결제 처리를 위해 제공해주신 결제 정보를 수집 및 저장할 수
							있으며, 결제 정보는 결제 외 다른 용도로 사용되지 않습니다. 취소 관련 문의는 <a
	...
	<div id="allMainContent" class="main-wrap">
		...
		<section id="renewalSlideNotice" class="slide-banner-wrap"
			...
			<article class="slide-banner">
				<section class="slide-banner-header">
					<div class="slide-banner-header-design-wrap">
						<span></span> <span></span> <span></span>
					</div>
					<span>플로우 6주년 <i class='icons-close-3'></i> 소문내기 캠페인
					</span>
					<button class="js-go-renewal">새로운 플로우 시작하기</button>
				</section>
				<section class="slide-banner-body">
					<button class="slide-banner-prev-btn">이전 버튼</button>
					<button class="slide-banner-next-btn">다음 버튼</button>
					<div class="slide-banner-navi-wrap color-dot">
						<span class="active"></span> <span></span> <span></span>
					</div>

					<div class="slide-banner-cont-mask">
						<div class="slide-banner-cont">
							<button class="js-go-url"
								url="https://forms.gle/naNKKzmM6oYy6D459">신청하기</button>
							<a href="#"> <img
								src="/img_renewal_banner/renewal-slide-banner-03.png"
								alt="보여줄게 완전히 달라진 나~ 플로우 무료시연회 (30분) - 신청하기">
							</a>
						</div>
						<div class="slide-banner-cont bright_cont">
							<button class="js-go-renewal">이벤트 자세히보기</button>
							<a href="#"> <img
								src="/img_renewal_banner/renewal-slide-banner-04.png"
								alt="새로워진 플로우, 친구에게 소개해주세요! 지금 소문내고 최신형 노트북, 아이패드 받자!! - 이벤트 자세히보기">
							</a>
						</div>
						<div class="slide-banner-cont">
							<button class="js-go-url"
								url="https://blog.naver.com/madrascheck/222484670050">블로그
								바로가기</button>
							<a href="#"> <img
								src="/img_renewal_banner/renewal-slide-banner-02.png"
								alt="너무 많이 달라져서 팝업으로는 부족해! 플로우 공식 블로그에서 확인해보세요! - 블로그 바로가기, 설문조사 참여만 해도 스타벅스 기프티콘!">
							</a>
						</div>
						<div class="slide-banner-cont">
							<button class="js-go-url"
				...
				<section class="slide-banner-footer">
					<input id="bannerHideChk" type="checkbox"> <label
						for="bannerHideChk">다시 보지 않기</label>
					<button class="js-close">닫기</button>
				</section>
			</article>
		</section>
		...
		<div class="main-top">
				...
				<div class="top-banner-1" banner="">
					<div class="top-banner-type-4">
						<div class="top-banner-sub-type-4">
							<span>플로우 데스크탑 버전을 이용해 보세요.</span> <a href="#">사용하기</a> <a
								href="#">나중에 하기</a> <a href="#">다시 물어보지 않기</a> <a href="#"
								class="top-banner-close-button"><i></i></a>
						</div>
					</div>
				</div>
            ...
            js-button-tooltip"
						...
						<i class="icon-alarm"></i> <i id="alarmTopCount"
							class="label-alarm" style="display: none"></i>
					</button>
		...
		<div class="multiLang">
			<button id="mutiLangButton" type="button"
				style="top: 50%; right: 10px; position: absolute; z-index: 11; transform: rotate(-90deg)">
				<img src="/flow-renewal/assets/images/icon-scroll-top.png"
					alt="MutiLang DebugMode">
			</button>

			<div id="mutiLangPopup" class="name-type-seach-popup d-none"
				style="top: 10%; right: 10px; width: 550px">
				<div id="mutiLangDebug" class="d-none">
					<p style="font-size: 20px">Internationalize</p>
					<p>Please press ctrl and click to edit language</p>
					<div>
						<p>Search</p>
						<ul class="section-name-list">
							<li data-code="search"
								class="js-search-section section-name-type-3"><a href="#">
									<span class="js-section-name">Search Language Code</span>
							</a></li>
						</ul>
						<p>Category</p>
						<ul class="section-name-list">
							<li data-code="dictionary"
								class="js-search-section section-name-type-1"><a href="#">
									<span class="js-section-name">Dictionary</span>
							</a></li>
							<li data-code="front"
								class="js-search-section section-name-type-2"><a href="#">
									<span class="js-section-name">Front</span>
							</a></li>
							<li data-code="back"
								class="js-search-section section-name-type-3"><a href="#">
									<span class="js-section-name">Back</span>
							</a></li>
						</ul>
					</div>
					<div>
						<p>Code</p>
						<div class="input-email-type-wrap-1">
							<input id="editLanguageCode" type="text"
								class="input-email-type-1 email-input" placeholder="Code">
							<a href="#" class="deleteEmail"></a> <span id="orgLangCode"
								class="d-none"></span>
						</div>

						<p>Korean</p>
						<div class="input-email-type-wrap-1">
							<input id="editKorean" type="text"
								class="input-email-type-1 email-input" placeholder="Korean">
							<a href="#" class="deleteEmail"></a>
						</div>

						<p>English</p>
						<div class="input-email-type-wrap-1">
							<input id="editEnglish" type="text"
								class="input-email-type-1 email-input" placeholder="English">
							<a href="#" class="deleteEmail"></a>
						</div>
						<p>Chinese</p>
						<div class="input-email-type-wrap-1">
							<input type="text" class="input-email-type-1 email-input"
								placeholder="Chinese"> <a href="#" class="deleteEmail"></a>
						</div>

						<p>Japnese</p>
						<div class="input-email-type-wrap-1">
							<input type="text" class="input-email-type-1 email-input"
								placeholder="Japanese"> <a href="#" class="deleteEmail"></a>
						</div>
					</div>
				</div>
				<div id="mutiLangSearch">
					<p style="font-size: 20px">Internationalize</p>
					<div>
						<p>Edit Language</p>
						<ul class="section-name-list">
							<li data-code="editLang"
								class="js-search-section search-option section-name-type-4">
								<a href="#"> <span class="js-section-name">Edit
										Language</span>
							</a>
							</li>
						</ul>
					...
					<div>
						...
						<ul class="section-name-list">
							<li data-code="KO_VAL"
								class="js-search-section search-option section-name-type-1">
								<a href="#" style="background: #999"> <span
									class="js-section-name">Korean</span>
							</a>
							</li>
							<li data-code="EN_VAL"
								class="js-search-section search-option section-name-type-2">
								<a href="#"> <span class="js-section-name">English</span>
							</a>
							</li>
							<li data-code="LANG_CODE"
								class="js-search-section search-option section-name-type-3">
								<a href="#"> <span class="js-section-name">Language
										Code</span>
							</a>
							</li>
						</ul>
					</div>
					<input id="searchCategory" type="hidden">
					<div>
						<p>Search</p>
						<div class="input-email-type-wrap-1">
							<input id="searchWord" type="text"
								class="input-email-type-1 email-input" placeholder="Type Here">
							<a href="#" class="deleteEmail"></a>
						</div>
					</div>
					<div>
						<p>Result</p>
						<p>Click your result to use code</p>
						<div class="detail-search-conditions">
							<ul id="langCodeResult" class="conditions-group"
								style="overflow: auto; max-height: 350px"></ul>
						</div>
					</div>
				</div>

				<div class="detail-search-conditions">
					<div class="condition-cell title">For Developer</div>
					<div class="condition-cell">
						<ul class="target-select-group">
							<li><input type="radio" name="langDevMode" id="jstlLangCode"
								value="jstl" class="radio-input" /> <label for="JSTL"
								class="js-devlang-type radio-label-checkbox">JSTL</label></li>
							<li><input type="radio" name="langDevMode"
								id="javaScriptLangCode" value="javascript" class="radio-input" />
								<label for="JavaScript"
								class="js-devlang-type radio-label-checkbox">JavaScript</label>
							</li>
							<li><input type="radio" name="langDevMode" id="javaLangCode"
								value="java" class="radio-input" /> <label for="Java"
								class="js-devlang-type radio-label-checkbox">JAVA</label></li>
							<li><input type="radio" name="langDevMode" id="noLangCode"
								value="none" class="radio-input" /> <label for="None"
								class="js-devlang-type radio-label-checkbox">None</label></li>
						</ul>
					</div>
				</div>
				<div class="detail-search-conditions">
					<div class="condition-button-area">
						<div class="condition-left">
							<button type="button" class="js-filter-reset condition-reset">Reset</button>
						</div>
						<div class="condition-right">
							<button class="js-filter-cancel condition-button cancel">Cancel</button>
							<button class="js-filter-search condition-button addOrEdit">Commit</button>
							<button class="js-filter-search condition-button search apply">Patch
								Server</button>
						</div>
					</div>
				</div>
			...
			<div id="mutiLangResultLi" class="d-none">
				<li data-korean="{korean}" data-engilsh="{english}"
					data-langcode="{fullCode}" class="js-file-type-search-filter"
					style="margin-top: 10px;">
					<div class="condition-cell title" style="width: 230px">
						<span class="lang_code">{code}</span> <span
							class="full_lang_code d-none">{fullCode}</span>
					</div>
					<div class="condition-cell font-size:12px">
						<div
							style="margin-bottom: 5px; font-size: 13px; word-break: keep-all;">Korean:
							{korean}</div>
						<div style="font-size: 13px; word-break: keep-all;">English:
							{english}</div>
						<div></div>
					</div>
				</li>
     ...
     -->
				<div id="leftTask" class="left-task active">
					...
					<ul id="leftMenuUl" class="menu-group js-left-menu mgt-20">
						<li data-code="main" class="left-menu-item"><a href="#">
								<i class="ico-home"></i>내 프로젝트 <em id="leftProjectHomeCount"
								class="js-project-home-count project-total-count d-none"></em>
						</a></li>
						<li data-code="open" class="left-menu-item d-none"><a
							href="#"> <i class="ico-search"></i>회사 공개 프로젝트
						</a></li>
						...
						<li data-code="unread" class="left-menu-item d-none"><a
							href="#"><i class="ico-letter"></i>미확인 <em
								...
								class="js-project-home-count project-total-count d-none"></em> </a>
						</li>
					...
					<ul id="leftBottomUl" class="menu-group admin">
						...
						<li data-code="service-upgrade" class="d-none left-menu-item">
							<a href="#"> <span class="ico-flow"><span
									class="path1"></span><span class="path2"></span><span
									class="path3"></span><span class="path4"></span><span
									class="path5"></span><span class="path6"></span><span
									class="path7"></span><span class="path8"></span></span>서비스 업그레이드
						</a>
						</li>
					</ul>
				</div>
            ...
            -->
				...
				<div id="topSettingBar" class="main-header">
					<div id="mainTop" class="title-1 d-none">프로젝트 홈</div>
					...
					<div id="projectHomeTop" class="main-sub-header d-none">
						...
						<div class="small-style-wrap">
							<div id="joinArea" style="display: none">
								...
								<div id="joinProjectLayer" class="popup-group-1"
									...
									<div class="content-group-1">
										<span>가입요청</span><strong class="badge-count"></strong>
							...
							<div class="section-wrap">
								<div id="BoardArea" class="project-board-wr"
									style="display: none">
									<div class="section-1">
										<ul id="projectBoardUl" class="project-group clearfix"></ul>
									</div>
								</div>
							...
							<div class="allFileLayer full-width small-style-wrap-2 d-none">
								...
								<ul id="fileLayerTitleItem" class="js-file-items-class">
									<a href="#" class="js-file-header"
										...
										<em
										class="flow-content-circle-type-1 project-color {project-color}"{project-color-display}></em>
													...
													<div class="condition-cell">
														<ul class="target-select-group">
															...
															<li class="js-remark-tmpl-type"><input type="radio"
																...
																class="radio-input" /> <label for="searchTargetRemark"
							...
							<div id="mainScroll"
								...
								<div
									...
									<div class="history-container">
										<div class="project-search-area all-file-header-type-3">
											<div class="project-search">
												<i class="icons-search"></i> <input id="historySearchInput"
													type="text" placeholder="검색" class="project-search-input" />
											</div>
										</div>
										<ul class="history-group scroll-mask"></ul>
									</div>
								</div>
			...
			<article id="organizationLayer" class="side-wr" style="display: none">
				...
				<div class="side-contents">
					...
					<div id="orgSearch" class="all-setup-type-2">
						<i class="icons-search"></i> <input id="organizationInput"
							...
							placeholder="이름, 소속, 전화번호 검색" autocomplete="off">
					</div>
					<div
				...
				<div id="organizationItem" style="display: none">
					<li class="department-item" dvsn-cd="{dvsn-cd}" depth="{depth}"
						hgrn-dvsn-cd="{hgrn-dvsn-cd}" dvsn-nm="{dvsn-nm}"{margin-style}>{group-icon}
						<em class="{button-class}"></em> <span style="cursor: pointer"
						class="group-tree-position-fix-type-{last-code} department-name group-tree-position-fix-type-1">{dvsn-nm}</span>
						<a href="#" class="js-dvsn-select {checked} d-none"{right-style}></a>
				...
				<div class="side-contents">
					...
					<div class="all-setup-type-2">
						<i class="icons-search"></i> <input id="chattingSearchInput"
							type="text" class="all-setup-input-type-1"
							placeholder="이름, 채팅방명 검색 " autocomplete="off">
					</div>
					...
					<li id="chatting-{ROOM_SRNO}" class="js-chatting-item"
						...
						<div class="mini-mode-text-sub-area-1">
							...
							<div class="mini-mode-chattng-type-3">
								<div class="mini-mode-chattng-type-text-1 not-read-count"{not-read-display}>{NOT_READ_CNT}</div>
			...
			<div id="inviteLayer" class="flow-all-background-1 d-none">
				...
				<div class="flow-project-make-1">
					<div class="flow-project-make-2">
						<div id="inviteMainLayer" class="detail-popup-type-1"
							...
							<ul id="inviteUl">
								<!--This DIV is deprecated (openTeamInvite)-->
								<li id="openTeamInvite" class="js-temporary-popup"><a
									href="#">
										<div class="detail-popup-icon-1">
											<span></span>
										</div>
										<div class="detail-popuplist-type-1">
											<span>회사 직원 초대</span> <em> 회사 직원 또는 조직도를 확인하고 초대할 수
												있습니다.</em>
										</div>
								</a></li>
								<!--This DIV is deprecated (openTeamInvite)-->
								<li id="openSendienceInvite" class="js-temporary-popup"><a
									href="#">
								...
								<li id="openTeamInvite" class="js-new-invitation-popup"><a
									href="#">
										<div class="detail-popup-icon-2">
											<span></span>
										</div>
										<div class="detail-popuplist-type-1">
											<span>참여자 초대</span> <em> 프로젝트를 함께했던 사람을 초대할 수 있습니다.</em>
										</div>
								</a></li>
						...
						<div id="sendInviteEmlLayer"
							...
							<div class="invite-email-area scroll-mask">
								...
								<a id="addEmail" href="#" class="email-plus-type-1"><em></em><span></span></a>
						...
						<!--This DIV is deprecated (teamInviteLayer)-->
						<div id="teamInviteLayer"
							class="name-type-seach-popup-type-1 js-temporary-popup"
							style="display: none">
							...
							<div class="flow-pop-button-type-1">
								<a href="#">
									...
									<div id="submitInvite" class="flow-pop-sub-button-2">초대</div>
								</a>
							</div>
						</div>
					</div>
				...
				<div id="selectMemberItem" style="display: none">
					<li rcvr_cd={rcvr-cd} rcvr_gb={rcvr-gb} id={id}><i{profile}></i>
						<a href="#"> <span class="member-name ellipsis">{name}</span>
			...
			<section id="invitePopup"
				class="js-dimmed-area imaginary-place js-new-invitation-popup"
				style="display: none">
				<div id="teamInviteLayer" class="project-invite-popup"
					style="display: none">
					<div class="project-invite-popup-header">
						<a href="#"><em class="returnMainBtn js-back-menu"></em></a> <span
							id="teamInviteHeader">회사 직원 초대</span>
						<button class="btn-close closeInviteLayerBtn">
							<i class="icons-close-1"></i>
						</button>
					...
					<div class="project-invite-popup-body clearfix">
						<ul class="project-invite-popup-navi">
						...
						<div id="teamInviteArea"
							...
							<div id="orgInviteSearch" class="project-invite-search">
								<i class="icons-search"></i> <input type="text"
									...
									class="project-invite-popup-search-input"
									placeholder="이름, 소속, 전화번호 검색">
							</div>

							<div class="project-invite-employee-case">
								<div
								...
								<div id="organizationDetailLayer"
									...
									<div class="sub-drag-picture-section-1 scroll-mask">
							...
							<div class="project-invite-ouside-case d-none">

								<div
									class="project-invite-only-list-wrap sub-drag-picture-section-1 scroll-mask">
									<div id="membersListForInvitation">
										<ul class="project-invite-choiceList"></ul>
									</div>
						...
						<div
							class="project-invite-memberList coperate-icon-list-type-1 scroll-mask">
							<div class="project-invite-selected-num">
								<span id="countFinalElement">5건 선택</span>
								<button id="removeAllElements">전체삭제</button>
							</div>
							<p id="blankInviteTarget" class="invite-blank-txt d-none">사용자를
								선택하세요.</p>
			...
			<div id="emplListItemForInvitation" style="display: none">
				<li class="js-member-item {active}" data-id="{USER_ID}"
					data-name="{FLNM}" rcvr_cd="{USER_ID}" rcvr_gb="{GUBUN}"
					use_intt_id="{use_intt_id}" id="{id}" profile-image="{PRFL_PHTG}">
					<div class="my-check-2 js-select-Btn {active}"></div>
					<div class="post-author">
						<span class="js-profile thumbnail size40 radius16"{image}></span>
						<dl class="post-author-info">
							<dt>
								<strong id="name" class="author">{FLNM}</strong> <em>{JBCL_NM}</em>
							</dt>
							<dd>
								<strong class="company">{CMNM}</strong> <span class="team">{DVSN_NM}</span>
							</dd>
						</dl>
					</div>
				</li>
			...
			<div id="inviteTargetListElement" style="display: none">
				<li data-id="{id}" data-type="{type}"
					class="js-invite-target {groupClass}"><i{image}></i> <a
					href="#"> <span class="member-name ellipsis">{name}</span>
				</a> <a href="#"> <em class="removeMemberItem"></em>
				</a></li>
			</div>

			<div id="groupListItemForInvitation" style="display: none">
				<li class="js-group-item" data-name="{GROUP_NM}"
					data-groupCd="{GROUP_CD}">{GROUP_NM} <a href="#"
					class="js-group-select {active}"></a></li>
			</div>
							...
							<div id="accountSettingLayer"
								...
								<div class="my-right-style adjust">
									...
									<a id="companyParticipationBtn"
										class="btn-company-participation" href="#">기존회사에 참여하기</a>

									<ul>
										<li id="upgradeBanner" class="upgrade-area adjust"
											style="display: none"><strong><span
										...
										<li class="adjust">
											...
											<div id="version" class="my-right-list-2"></div>
										</li>
										<li class="adjust">
										...
										<li class="edit-input js-dvsn-set adjust">
											<div class="my-right-list-1">소속</div>
											<div class="read-mode d-block">
	...
	<div id="bottomToolList" class="bottom-tool-list">
		<div class="js-tool-item tool-item" id="quickGuideMenu"
			data-code="quick" style="display: none;">
			<button type="button"
			...
			<div class="js-bottom-quick-layer quick-guide quick-pop d-none">
				...
				<div class="quick-guide-contents">
					...
					<ul id="quickGuideList" class="quick-guide-list"></ul>
				</div>
			</div>
		</div>
		...
		<li id="post-{COLABO_COMMT_SRNO}"
			...
			<div class="js-post-nav list-item post-list-wrapper">
				<div class="fixed-list">
					<a href="#"> <i class="js-indication display-new-indication"{alarm-display}></i>
						<div class="fixed-kind">
							<i class="icons-{post-gb}"></i> <span>{post-name}</span>
						</div>
						...
						<div class="post-list-right">
							...
							<div class="post-list date">{date}</div>
							<div class="fixed-value">
								<span class="js-todo-state state request d-none"{todo-display}>{TODO_DONE_PERCENT}</span>
								...
								<div class="post-option">
									...
									<ul class="js-setting-ul js-setting-layer setup-group d-none">
										...
										<li class="js-setting-item" data-code="delete"{menu-delete-display}>
											<a href="#"> <i class="icons-delete-3"></i>삭제
										</a>
										</li>
										...
										<li class="js-setting-item" data-code="url"{menu-url-display}>
											<a href="#"> <i class="icons-copy"></i>링크 복사
										</a>
										</li>
									</ul>
								</div>
	...
	<div id="detailItemPack" class="d-none">
		...
		<div id="fileComponent" class="d-none">
			<div class="js-post-file document-item file-item" data-code="FILE"
				...
				<div class="extension-icon-area">
					<i class="icon-extension {ext-class}"></i> <span class="file-lock"{lock-icon-display}><i
						class="icons-lock"></i></span>
		...
		<div id="taskComponent" class="d-none">
			<div class="js-task-option">
				<ul class="create-content-group">
					...
					<li class="js-task-worker-layer js-more-task-li d-none"{data-worker-layer-display}>
						...
						<div class="create-content-cell manager-btn-group">
							<span class="js-workers manager-group">{workers} </span> <input
								type="text" class="js-worker-input worker-search-input d-none"
								placeholder="담당자 추가">
					...
					<li
						class="js-date-layer js-start-date-layer js-more-task-li d-none"{start-date-text-display}>
						<div class="create-content-cell title">
							<i class="icon-post-date"></i>
						</div>
						<div class="js-date-option create-content-cell">
							<div class="js-pickr-layer js-start-flatpickr">
								<label type="button" class="js-date-label add-manager-button"{start-date-button-display}>
									<input class="js-pickr-date flatpickr-input ie-pickr"
					...
					<li class="js-date-layer js-end-date-layer js-more-task-li d-none"{end-date-text-display}>
						...
						<div class="js-date-option create-content-cell">
							<div class="js-pickr-layer js-end-flatpickr">
								<label type="button" class="js-date-label add-manager-button"{end-date-button-display}>
									<input class="js-pickr-date flatpickr flatpickr-input ie-pickr"
					...
					<li class="js-priority-layer js-more-task-li"{priority-display}>
						...
						<div class="js-priority create-content-cell"
							...
							<button id="priorityButton" type="button"
								class="js-priority-button js-priority-event add-manager-button"{priority-button-display}>
							</button>
							<div id="prioritySpan"
								class="js-priority-span js-priority-event rank-item"{priority-text-display}>
				...
				<button type="button" class="js-more-button add-button"{more-button-display}>
		...
		<div id="todoRgsrComponent" class="d-none">
			<span id="todoRgsrInfo" style="display: none" rgsr-id={rgsr-id}
				self-yn={self-yn} mngr-wr-yn={mngr-wr-yn} mngr-dsnc={mngr-dsnc}></span>
		</div>
		<div id="todoMenuComponent" class="d-none">
			<span id="todoDateSpan"
				class="js-pickr-layer todo-date js-mouseover {dead-line-class}"
				select-date="{select-date}" mouseover-text="{mouseover-date}"{todoDate-data-display}>{req-time}</span>
			...
			<div class="js-todo-edit-layer subtask-input-area todo-area">
				...
				<div class="todo-menu">
					<span class="js-pickr-layer js-datepick-button subtask-button">
						<input type="hidden"
						class="flatpickr flatpickr-input js-pickr-date" type="text"
		...
		<div id="todoItemComponent" class="d-none">
			<li class="todo-item" todo-list-srno={todo-list-srno}
				...
				<div class="subtask-input-area todo-area {checked}">
					...
					<p class="todo-text">
						<a href="#" class="icon-checkbox js-todo-checkbox"{icon-checkbox-display}>
					...
					<li id="videoLi"{video-display}>
						...
						<div class="create-content-cell">
							<button id="videoButton" type="button"
								class="add-manager-button {video-active}"></button>
						...
						<fieldset>
							...
							<div class="{title-display}">
								<input id="postTitle" type="text" title="제목을 입력하세요."
									...
									maxlength="100" data-empty-msg="제목을 입력하세요!"></input>
							</div>
							<div id="postCntn"
	...
	<ul id="workerListItem" class="d-none">
		<li href="#">
			<div class="js-registration all-seach-section-wrap-2"
				...
				<div class="js-worker-profile all-seach-popup-write-2"
					{profile} data-profile="{profile-data}"></div>
				...
				<ul class="js-subtask-menu subtask-menu">
					<li
						...
						<div class="js-pickr-layer">
							<input type="hidden" class="js-subtask-date-input" type="text"
								readonly="readonly">
					...
					<li
						...
						<button type="button"
							class="js-priority-level icon-subtask-level js-priority-button {priority_code}"{priority_icon_display}>
							<em class="blind"></em>
						</button>
						<button type="button"
	...
	<div id="memberItem" style="display: none">
		<li class="js-participant-item" data-id={rcvr-cd} rcvr_cd={rcvr-cd}
			rcvr_gb={rcvr-gb} id="{id}" sendience_gb="{sendience-gb}"
	...
	<script src="/flow-renewal/dist/js/commonLib.min.js?5.1.699.10767"></script>
	<script src="/flow-renewal/dist/js/common.min.js?5.1.699.10767"></script>



	<script src="/flow-renewal/dist/js/module.min.js?5.1.699.10767"></script>
	...
	<script>
		...
		var _CLIENT_IP = "180.71.250.238, 130.176.126.97";

		var _PTL_ID = "PTL_3";
		var _CHNL_ID = "CHNL_1";
		var _USE_INTT_ID = "KAKAO_211003154523";
		var _USE_INTT_NM = "";
		var _USER_ID = "kakao_1934981996";
		var _USER_NM = "오혜지";
		var _USER_EMAIL = "";
		var _RGSN_DTTM = "FLOW_kXUQUQhNd94zF%2FFw3nzhCw%3D%3D";
		var _PRFL_PHTG = "";
		var _BSNN_NM = "";
		var _DVSN_NM = "";
		var _DVSN_CD = "";
		var _ONE_COLABO_SRNO = "1061411";
		var _BUY_YN = "N";
		...
		var _IsMini = Often.isAct("mini");

		var _FLOW_DRIVE_UUID = "";

		_ENTER_YN = (Often.isServerModeByHost("DEV_TEST") ? "N" : _ENTER_YN);

		if (!Often.isServerModeByHost("REAL")
				&& !Often.isServerModeByHost("REAL_TEST"))
			Often.setCookie("MINIFY_YN", "N");
		//if (true) Often.setCookie("MINIFY_YN", "Y");
	...
	<script src="/flow-renewal/dist/js/main.min.js?5.1.699.10767"></script>
	<script src="/flow-renewal/dist/js/mainLib.min.js?5.1.699.10767"></script>
		...
		<div id="profilePopup">
			...
			<div class="btn-wr">
				...
				<button class="btn-video js-btn-video"
					{btn_video_display} USER_ID="{USER_ID}">
					화상 회의 <i></i>
				</button>
			</div>
		</div>
		...
		<div class="js-file-SearchFilter">
			...
			<ul id="periodLi">
				<li><input id="{uuid}" type="radio" name="period-type"
					class="radio-input {select_class}" data-code="{key}" {checked}/> <label
					for="{uuid}" class="js-period-type radio-label-checkbox"
		...
		<div class="js-file-ItemSchedule">
			<ul id="participantItemLi">
				<li class="js-participant-item" id="participant-item">
					<div id="{id}" class="confirmation-item js-user-id">
						<div
							class="js-participant-profile participant-thumbnail attendee {gubun}"{profile}></div>
			...
			<div id="attendanceViewItem">
				<span
					...
					{profile}
                  data-worker-id="{id}"
					data-registration-name="{name}" mouseover-text="{name}"></span>
			</div>
