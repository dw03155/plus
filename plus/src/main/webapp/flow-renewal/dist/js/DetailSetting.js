var DetailSetting = (function () {
    ...
    function deleteSendience(rcvrGb, userId, callback) {
        ...
        Ajax.executeApi(RestApi.DELETE.COLABO2_SENDIENCE_D001, sendienceData, function (dat) {
            if (userId === _USER_ID) {
            ...
            if (errorCode === "S0151") Often.toast("error", Often.null2Void(dat.COMMON_HEAD.MESSAGE, "프로젝트 관리자는 최소 한명이 존재해야합니다."));
