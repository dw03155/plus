    ...
    function initEditPopup($postPopup, onePostData, isOnTab) {
        ...
        function fillPostByData() {
            ...
            if (postCode === DetailCode.TASK) {
                ...
                !isSharePost && $postPopup.find(".js-subtask-ul").append(ItemSubtask.getCompHtml(onePostData.SUBTASK_REC, !isViewPost));
            }
            ...
            function fillContentEditable() {
                ...
                if (componentsArray.length === 0) {
                    $uploadArea.append(TagConvert.db2HtmlStringByPost(postContents));
                    return;
                }

                componentsArray.forEach(function (component) {
                    if (component.COMP_TYPE === "TEXT") {
                        $uploadArea.append(TagConvert.db2HtmlStringByPost(component.COMP_DETAIL.CONTENTS, isSharePost));
                        return;
                    }
